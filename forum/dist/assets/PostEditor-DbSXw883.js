...
<head>
  ...
  <style>
    ...
    .capubbs-html-frame-root{display:flow-root;width:calc(100% - ${z}px);${h}}.capubbs-html-frame-root iframe{display:inline-block;vertical-align:baseline}a{color:${o}}img,video,canvas,svg{max-width:100%;height:auto}pre{max-width:100%;overflow:auto;white-space:pre-wrap}table{max-width:100%}
  </style>
