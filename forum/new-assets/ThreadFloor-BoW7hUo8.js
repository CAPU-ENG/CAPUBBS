import{w as Fe,r as l,a4 as lt,bA as ct,j as a,a5 as ut,a0 as Ae,d as dt,e as mt,bB as pt,bC as ft,bD as gt,bE as ht,bF as bt,aS as yt,aK as xt,aZ as vt,aM as wt,bG as It,bH as At,bI as St,bJ as kt,bK as Rt,a9 as Et,Z as ie,G as Ct,ab as jt,bg as Lt,bL as Nt}from"./index-CQ_Q9Iaq.js";import{e as Tt,d as Te,m as pe,s as qt,f as Pt,r as Mt,h as $t,a as Oe,P as He}from"./RichTextEditor.gallery-D4kgpc4i.js";import{P as zt}from"./plus-B2dtHIc9.js";import{R as Dt}from"./rotate-ccw-BM6JW-vZ.js";import{f as Ft}from"./dataDisplay-BC_NQL7k.js";import{D as Ge,T as fe}from"./TagBadge-CsAeRk88.js";import{T as Se}from"./trash-2-DcTWuONs.js";import{P as qe}from"./pencil-DGfM_WB1.js";import{E as Ot}from"./external-link-D3xtdBbQ.js";import{T as Ht}from"./triangle-alert-Cd58bUCt.js";const Gt=[["path",{d:"m16 6-8.414 8.586a2 2 0 0 0 2.829 2.829l8.414-8.586a4 4 0 1 0-5.657-5.657l-8.379 8.551a6 6 0 1 0 8.485 8.485l8.379-8.551",key:"1miecu"}]],Ut=Fe("paperclip",Gt);const _t=[["path",{d:"M20 18v-2a4 4 0 0 0-4-4H4",key:"5vmcpk"}],["path",{d:"m9 17-5-5 5-5",key:"nvlc11"}]],Bt=Fe("reply",_t);async function Wt(e){try{if(navigator.clipboard?.writeText)return await navigator.clipboard.writeText(e),!0}catch{}const r=document.createElement("textarea");r.value=e,r.setAttribute("readonly",""),r.style.position="fixed",r.style.opacity="0",document.body.appendChild(r),r.select();try{return document.execCommand("copy")}finally{r.remove()}}const Yt=400;function na(e,r){return r?`回复 @${r}：${e}`:e}function Vt(e){const r=Array.from(e).length,t=Yt,o=r>t;return{canSubmit:!!e.trim()&&!o,isOverLimit:o,length:r,limit:t}}const Kt={black:0,darkgray:169,darkgrey:169,dimgray:105,dimgrey:105,gainsboro:220,gray:128,grey:128,lightgray:211,lightgrey:211,silver:192,white:255,whitesmoke:245},ge="data-capubbs-original-grayscale-color-attr",he="data-capubbs-original-grayscale-style-color";function Jt(e){const r=String(e??"").trim().toLowerCase().replace(/^['"]|['"]$/g,""),t=r.replace(/\s+/g,""),o=Kt[t];if(typeof o=="number")return{alpha:1,channel:o};const n=t.match(/^#?([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/);if(n){const s=n[1].length<=4?n[1].split("").map(p=>`${p}${p}`).join(""):n[1],f=Number.parseInt(s.slice(0,2),16),g=Number.parseInt(s.slice(2,4),16),I=Number.parseInt(s.slice(4,6),16),y=s.length===8?Number.parseInt(s.slice(6,8),16)/255:1;return f===g&&g===I?{alpha:y,channel:f}:null}const u=r.match(/^rgba?\(\s*(\d{1,3}(?:\.\d+)?%?)(?:\s*,\s*|\s+)(\d{1,3}(?:\.\d+)?%?)(?:\s*,\s*|\s+)(\d{1,3}(?:\.\d+)?%?)(?:\s*(?:,|\/)\s*([01](?:\.\d+)?|\.\d+|100%|\d{1,3}(?:\.\d+)?%))?\s*\)$/);if(!u)return null;const i=be(u[1]),c=be(u[2]),d=be(u[3]),b=er(u[4]);return i===null||c===null||d===null||b===null?null:i===c&&c===d?{alpha:b,channel:i}:null}function Ue(e,r=!0){const t=Jt(e);if(!t)return null;const o=255-t.channel;if(r&&t.alpha<1)return`rgba(${o}, ${o}, ${o}, ${tr(t.alpha)})`;const n=o.toString(16).padStart(2,"0");return`#${n}${n}${n}`}function Xt(e,r){[...e.matches("[color], [style]")?[e]:[],...Array.from(e.querySelectorAll("[color], [style]"))].forEach(o=>{Qt(o,r),o instanceof HTMLElement&&Zt(o,r)})}function Qt(e,r){const t=e.getAttribute(ge);if(r==="light"){if(t===null)return;e.setAttribute("color",t),e.removeAttribute(ge);return}const o=t??e.getAttribute("color"),n=Ue(o,!1);!n||o===null||(t===null&&e.setAttribute(ge,o),e.getAttribute("color")!==n&&e.setAttribute("color",n))}function Zt(e,r){const t=e.getAttribute(he);if(r==="light"){if(t===null)return;e.style.setProperty("color",t,e.style.getPropertyPriority("color")),e.removeAttribute(he);return}const o=t??e.style.getPropertyValue("color"),n=Ue(o);!n||!o||(t===null&&e.setAttribute(he,o),e.style.getPropertyValue("color")!==n&&e.style.setProperty("color",n,e.style.getPropertyPriority("color")))}function be(e){const r=e.endsWith("%"),t=Number(r?e.slice(0,-1):e);return Number.isFinite(t)?r?t>=0&&t<=100?Math.round(t*2.55):null:t>=0&&t<=255?Math.round(t):null:null}function er(e){if(e===void 0)return 1;const r=e.endsWith("%"),t=Number(r?e.slice(0,-1):e);return Number.isFinite(t)?r?t>=0&&t<=100?t/100:null:t>=0&&t<=1?t:null:null}function tr(e){return Number(e.toFixed(3))}function rr(e){const r=[];return e.querySelectorAll("table").forEach(t=>{if(t.classList.contains("forum-punishment-table")||t.parentElement?.closest("table")||t.querySelector("table")||t.rows.length<2||!Array.from(t.rows).some(s=>s.cells.length>1))return;let o=t.parentElement;if(!o?.classList.contains("forum-table-scroll")){o=t.ownerDocument.createElement("div"),o.className="forum-table-scroll",o.tabIndex=0,t.before(o),o.append(t),t.classList.add("forum-data-table");let s=[],f=null;Array.from(t.rows).forEach((g,I)=>{f!==g.parentElement&&(f=g.parentElement,s=[]);let y=0;Array.from(g.cells).forEach(p=>{for(;(s[y]??0)>0;)y+=1;y===0&&p.colSpan===1&&p.classList.add("forum-table-first-column"),I===0&&!t.tHead&&p.classList.add("forum-table-heading");const k=p.rowSpan===0?t.rows.length:p.rowSpan;for(let S=0;S<p.colSpan;S+=1)s[y+S]=k;y+=p.colSpan;const E=t.ownerDocument.createElement("div");for(E.className="forum-table-cell-content";p.firstChild;)E.append(p.firstChild);p.append(E)}),s=s.map(p=>Math.max(0,p-1))})}const n=o;let u=n.parentElement;u?.classList.contains("forum-table-viewport")||(u=t.ownerDocument.createElement("div"),u.className="forum-table-viewport",n.before(u),u.append(n));const i=u,c=()=>{n.classList.toggle("forum-table-scrolled",n.scrollLeft>0),i.classList.toggle("forum-table-more-right",n.scrollWidth-n.clientWidth-n.scrollLeft>1)};c(),n.addEventListener("scroll",c,{passive:!0});const d=t.ownerDocument.defaultView,b=d?.ResizeObserver?new d.ResizeObserver(c):null;b?.observe(n),b?.observe(t),d?.addEventListener("resize",c),r.push(()=>{n.removeEventListener("scroll",c),b?.disconnect(),d?.removeEventListener("resize",c)})}),()=>r.forEach(t=>t())}function _e(e){const r=e.ownerDocument.defaultView;if(!r)return()=>{};const t=[];return e.querySelectorAll(".forum-punishment-table").forEach(o=>{const n=o.parentElement;if(!n?.classList.contains("forum-punishment-scroll"))return;let u=!1;function i(){if(u||!n)return;const d=n.clientWidth,b=Math.max(o.offsetWidth,o.scrollWidth);if(d<=0||b<=0)return;const s=Math.min(1,d/b),f=`scale(${s})`,g=`${Math.ceil(o.offsetHeight*s)}px`;o.style.transform!==f&&(o.style.transform=f),n.style.height!==g&&(n.style.height=g)}const c=r.ResizeObserver?new r.ResizeObserver(i):null;c?.observe(n),c?.observe(o),r.addEventListener("resize",i),e.ownerDocument.fonts?.ready.then(i),i(),t.push(()=>{u=!0,c?.disconnect(),r.removeEventListener("resize",i)})}),()=>t.forEach(o=>o())}function Be({className:e="",html:r,onImageOpen:t,variant:o}){const n=l.useRef(null),{theme:u}=lt(),i=l.useMemo(()=>({__html:r}),[r]);if(l.useLayoutEffect(()=>{const s=n.current;if(s&&o!=="signature")return rr(s)},[r,o]),l.useLayoutEffect(()=>{const s=n.current;if(s&&o!=="signature")return _e(s)},[r,o]),l.useLayoutEffect(()=>{const s=n.current;s&&(Tt(s),Xt(s,u))},[r,u]),l.useLayoutEffect(()=>{const s=n.current;if(s)return ct(s)},[r]),l.useEffect(()=>{const s=n.current;if(!s)return;const f=Array.from(s.querySelectorAll("img")),g=y=>{y.dataset.capubbsImageLoaded="true"},I=f.map(y=>{if(y.complete)return g(y),null;const p=()=>g(y);return y.addEventListener("load",p,{once:!0}),y.addEventListener("error",p,{once:!0}),{handleLoad:p,image:y}});return()=>{I.forEach(y=>{y&&(y.image.removeEventListener("load",y.handleLoad),y.image.removeEventListener("error",y.handleLoad))})}},[r]),!r)return null;function c(s,f){if(!t||!(s instanceof Element))return;const g=s.closest("img");if(!(g instanceof HTMLImageElement))return;const I=g.closest(".capubbs-gallery"),y=I?Array.from(I.querySelectorAll('[data-capubbs-gallery-slide="true"] img')):Array.from(f.querySelectorAll("img")).filter(R=>!R.closest(".capubbs-gallery")),p=y.indexOf(g);if(p<0)return;const k=y.map(R=>ar(R,f)),E=y.map((R,T)=>{const P=k[T];return{alt:R.alt.trim(),element:R,src:R.currentSrc||R.src,...P?{galleryId:P.galleryId,galleryIndex:P.galleryIndex}:{}}});t(E,p,g,R=>{const T=k[R];T&&qt(T.gallery,T.galleryIndex)})}function d(s){const f=Te(s.target);if(f&&s.target instanceof Element){s.preventDefault(),s.stopPropagation(),pe(s.target,f);return}!t||!(s.target instanceof HTMLImageElement)||(s.preventDefault(),c(s.target,s.currentTarget))}function b(s){const f=Te(s.target);if(f&&["Enter"," "].includes(s.key)&&s.target instanceof Element){s.preventDefault(),pe(s.target,f);return}if(["ArrowLeft","ArrowRight"].includes(s.key)&&s.target instanceof Element&&s.target.closest(".capubbs-gallery")){s.preventDefault(),pe(s.target,s.key==="ArrowLeft"?"prev":"next");return}!t||!(s.target instanceof HTMLImageElement)||!["Enter"," "].includes(s.key)||(s.preventDefault(),c(s.target,s.currentTarget))}return a.jsx("div",{ref:n,className:`forum-markup forum-markup-${o} ${e}`.trim(),"data-forum-markup":o,dangerouslySetInnerHTML:i,onClick:d,onKeyDown:b})}function ar(e,r){const t=e.closest(".capubbs-gallery");if(!t||!r.contains(t))return null;const n=Array.from(r.querySelectorAll(".capubbs-gallery")).indexOf(t),i=Array.from(t.querySelectorAll('[data-capubbs-gallery-slide="true"] img')).indexOf(e);return n>=0&&i>=0?{gallery:t,galleryId:n,galleryIndex:i}:null}const G=1,We=4,ce=.25;function nr(e){return Math.min(We,Math.max(G,e))}function ye(e){const[r,t]=[...e.values()];return!r||!t?null:Math.hypot(t.x-r.x,t.y-r.y)}function or({images:e,initialImageIndex:r,onImageChange:t,onClose:o}){const n=Math.min(Math.max(0,r),Math.max(0,e.length-1)),[u,i]=l.useState(n),[c,d]=l.useState(G),[b,s]=l.useState({x:0,y:0}),[f,g]=l.useState(!1),I=l.useRef(null),y=l.useRef(null),p=l.useRef(null),k=l.useRef(null),E=l.useRef(n),S=l.useRef(G),R=l.useRef({x:0,y:0}),T=l.useRef(null),P=l.useRef(!1),N=l.useRef(new Map),H=l.useRef(null),z=l.useRef(G),X=l.useRef(t),K=l.useRef(o);X.current=t,K.current=o;function Q(m,x=S.current){const w=I.current,M=p.current;if(!w||!M||x<=G)return{x:0,y:0};const B=Math.max(0,(M.clientWidth*x-w.clientWidth)/2),q=Math.max(0,(M.clientHeight*x-w.clientHeight)/2);return{x:Math.min(B,Math.max(-B,m.x)),y:Math.min(q,Math.max(-q,m.y))}}function U(m,x=S.current){const w=Q(m,x);R.current=w,s(w)}function _(m){const x=Math.round(nr(m)*100)/100;S.current=x,d(x),U(R.current,x)}function Z(){S.current=G,R.current={x:0,y:0},d(G),s({x:0,y:0})}function C(m){const x=Math.min(Math.max(0,m),e.length-1);x!==E.current&&(E.current=x,i(x),Z(),X.current?.(x))}function F(){K.current(E.current)}l.useEffect(()=>{const m=document.body.style.overflow,x=document.activeElement,w=I.current;document.body.style.overflow="hidden",k.current?.focus();function M(v){if(v.key==="Escape"){v.preventDefault(),F();return}if(v.key==="ArrowLeft"){v.preventDefault(),v.stopPropagation(),C(E.current-1);return}if(v.key==="ArrowRight"){v.preventDefault(),v.stopPropagation(),C(E.current+1);return}if(v.key==="+"||v.key==="="){v.preventDefault(),v.stopPropagation(),_(S.current+ce);return}if(v.key==="-"){v.preventDefault(),v.stopPropagation(),_(S.current-ce);return}if(v.key==="0"){v.preventDefault(),v.stopPropagation(),Z();return}if(v.key==="Tab"){const W=y.current?.querySelectorAll("button:not(:disabled)");if(!W?.length)return;const re=W[0],se=W[W.length-1],ae=document.activeElement;if(v.shiftKey&&ae===re){v.preventDefault(),se.focus();return}if(!v.shiftKey&&ae===se){v.preventDefault(),re.focus();return}y.current?.contains(ae)||(v.preventDefault(),re.focus())}}function B(v){if(v.preventDefault(),v.stopPropagation(),v.deltaY===0)return;const W=v.ctrlKey?.01:.002;_(S.current*Math.exp(-v.deltaY*W))}function q(v){v.preventDefault(),v.stopPropagation(),z.current=S.current}function V(v){if(v.preventDefault(),v.stopPropagation(),N.current.size>=2)return;const W=v.scale;typeof W=="number"&&_(z.current*W)}function oe(){U(R.current,S.current)}return document.addEventListener("keydown",M,{capture:!0}),window.addEventListener("resize",oe),w?.addEventListener("wheel",B,{passive:!1}),w?.addEventListener("gesturestart",q,{passive:!1}),w?.addEventListener("gesturechange",V,{passive:!1}),w?.addEventListener("gestureend",V,{passive:!1}),()=>{document.removeEventListener("keydown",M,{capture:!0}),window.removeEventListener("resize",oe),w?.removeEventListener("wheel",B),w?.removeEventListener("gesturestart",q),w?.removeEventListener("gesturechange",V),w?.removeEventListener("gestureend",V),document.body.style.overflow=m,x instanceof HTMLElement&&x.focus()}},[]);function ee(m,x,w){T.current={pointerId:m,startX:x,startY:w,originX:R.current.x,originY:R.current.y},g(!0)}function A(m){if(m.target instanceof Element&&m.target.closest("button, .thread-image-lightbox-controls"))return;const x=m.pointerType==="touch",w=m.pointerType==="mouse"&&m.button===0;if(!(!x&&!w)&&(P.current=!1,!(!x&&S.current<=G))){if(m.preventDefault(),m.currentTarget.setPointerCapture(m.pointerId),x&&(N.current.set(m.pointerId,{x:m.clientX,y:m.clientY}),N.current.size===2)){H.current=ye(N.current),T.current=null,g(!1);return}S.current>G&&ee(m.pointerId,m.clientX,m.clientY)}}function Y(m){const x=N.current.has(m.pointerId),w=T.current;if(!x&&w?.pointerId!==m.pointerId)return;if(m.preventDefault(),m.stopPropagation(),x&&N.current.set(m.pointerId,{x:m.clientX,y:m.clientY}),N.current.size===2){const q=ye(N.current),V=H.current;if(!q||!V){H.current=q;return}Math.abs(q-V)>1&&(P.current=!0),_(S.current*(q/V)),H.current=q;return}if(!w||S.current<=G)return;const M=m.clientX-w.startX,B=m.clientY-w.startY;Math.hypot(M,B)>3&&(P.current=!0),U({x:w.originX+M,y:w.originY+B})}function L(m){const x=N.current.delete(m.pointerId),w=T.current?.pointerId===m.pointerId;if(!(!x&&!w)){if(H.current=N.current.size===2?ye(N.current):null,N.current.size===1&&S.current>G){const[M]=N.current.entries();if(M){const[B,q]=M;ee(B,q.x,q.y)}}else T.current=null,g(!1);m.currentTarget.hasPointerCapture(m.pointerId)&&m.currentTarget.releasePointerCapture(m.pointerId)}}const O=Math.round(c*100),j=e[u]??e[0];return j?ut.createPortal(a.jsx("div",{className:"thread-image-lightbox-backdrop","data-can-pan":c>G,"data-dragging":f,onClick:m=>{if(P.current)return;const x=m.target;x instanceof Element&&x.closest("img, button, .thread-image-lightbox-controls")||F()},onPointerCancel:L,onPointerDown:A,onPointerMove:Y,onPointerUp:L,ref:I,role:"presentation",children:a.jsxs("figure",{"aria-label":j.alt?`图片预览：${j.alt}（${u+1}/${e.length}）`:`图片预览（${u+1}/${e.length}）`,"aria-modal":"true",className:"thread-image-lightbox",ref:y,role:"dialog",children:[a.jsx("button",{"aria-label":"关闭图片预览",className:"thread-image-lightbox-close",onClick:F,ref:k,type:"button",children:a.jsx(Ae,{size:20})}),e.length>1&&a.jsxs(a.Fragment,{children:[a.jsx("button",{"aria-label":"上一张图片",className:"thread-image-lightbox-nav thread-image-lightbox-prev",disabled:u===0,onClick:()=>C(u-1),title:"上一张（←）",type:"button",children:a.jsx(dt,{size:28})}),a.jsx("button",{"aria-label":"下一张图片",className:"thread-image-lightbox-nav thread-image-lightbox-next",disabled:u===e.length-1,onClick:()=>C(u+1),title:"下一张（→）",type:"button",children:a.jsx(mt,{size:28})})]}),a.jsx(sr,{image:j,imageRef:p,onReady:()=>U(R.current,S.current),transform:`translate3d(${b.x}px, ${b.y}px, 0) scale(${c})`}),j.alt&&a.jsx("figcaption",{children:j.alt}),a.jsxs("div",{"aria-label":"图片缩放",className:"thread-image-lightbox-controls",role:"toolbar",children:[a.jsx("button",{"aria-label":"缩小图片",disabled:c<=G,onClick:()=>_(c-ce),title:"缩小（-）",type:"button",children:a.jsx(Pt,{size:18})}),a.jsxs("output",{"aria-label":"当前缩放比例","aria-live":"polite",children:[O,"%"]}),a.jsx("button",{"aria-label":"放大图片",disabled:c>=We,onClick:()=>_(c+ce),title:"放大（+）",type:"button",children:a.jsx(zt,{size:18})}),a.jsx("button",{"aria-label":"恢复原始大小",disabled:c===G,onClick:Z,title:"恢复原始大小（0）",type:"button",children:a.jsx(Dt,{size:17})})]})]})}),document.body):null}function sr({image:e,imageRef:r,onReady:t,transform:o}){const n=l.useRef(null),u=l.useRef(t);return u.current=t,l.useLayoutEffect(()=>{const i=e.element,c=n.current,d=i?.parentNode;if(!i||!c?.parentNode||!d)return;const b=i.ownerDocument.createComment("capubbs-lightbox-image"),s=i.getAttribute("style"),f=i.getAttribute("draggable");d.insertBefore(b,i),c.parentNode.insertBefore(i,c),i.draggable=!1,r.current=i;const g=()=>u.current();return i.addEventListener("load",g),i.complete&&g(),()=>{i.removeEventListener("load",g),s===null?i.removeAttribute("style"):i.setAttribute("style",s),f===null?i.removeAttribute("draggable"):i.setAttribute("draggable",f),b.parentNode?.insertBefore(i,b),b.remove(),r.current===i&&(r.current=null)}},[e,r]),l.useLayoutEffect(()=>{e.element&&(e.element.style.transform=o)},[e,o]),e.element?a.jsx("span",{hidden:!0,ref:n}):a.jsx("img",{alt:e.alt,draggable:"false",onLoad:t,ref:r,src:e.src,style:{transform:o}})}function ir(e){if(!/<punishment_record\b/i.test(e))return null;const r=document.createElement("template");r.innerHTML=e;const t=Array.from(r.content.querySelectorAll("punishment_record")).filter(n=>!n.closest("pre, code, textarea"));if(t.length===0)return null;const o=t.map(n=>{const u=n.getAttribute("year")?.trim()??"",i=/^\d{4}$/.test(u)&&Number(u)>1?Number(u):null,c=document.createElement("div");return n.replaceWith(c,...Array.from(n.childNodes)),{placeholder:c,year:i}});return{needsRecords:o.some(({year:n})=>n!==null),render(n,u){return o.forEach(({placeholder:i,year:c})=>{if(c===null||u){i.textContent=c===null?"罚跑记录学年无效":u;return}const d=document.createElement("table"),b=`${c-1}-${c} 学年罚跑记录`;d.className="forum-punishment-table",d.setAttribute("aria-label",b);const s=document.createElement("div");s.className="forum-punishment-title",s.setAttribute("role","heading"),s.setAttribute("aria-level","2"),s.textContent=b;const f=d.createTHead().insertRow();["姓名","ID","原因","长度","职务加罚","开始时间","结束时间","完成情况"].forEach(p=>{const k=document.createElement("th");k.scope="col",k.textContent=p,f.append(k)});const g=d.createTBody(),I=n.filter(p=>{const k=p.startDate.match(/^(\d{4})-(\d{1,2})-/);if(!k)return!1;const E=Number(k[2]);return E>=1&&E<=12&&Number(k[1])+(E>=9?1:0)===c});if(I.forEach(p=>{const k=g.insertRow(),E=p.distance?/公里|km/i.test(p.distance)?p.distance:`${p.distance} km`:"—";[p.name||"—",p.username||"—",p.reason||"—",E,p.addition?"是":"否",Pe(p.startDate),Pe(p.endDate),p.isComplete?"已完成":"进行中"].forEach(S=>{k.insertCell().textContent=S})}),I.length===0){const p=g.insertRow().insertCell();p.colSpan=8,p.className="forum-punishment-empty",p.textContent="暂无罚跑记录"}const y=document.createElement("div");y.className="forum-punishment-scroll",y.append(d),i.className="forum-punishment-record",i.replaceChildren(s,y)}),r.innerHTML}}}function Pe(e){return!e||e==="0000-00-00"?"—":e.replaceAll("-",".")}function lr(e,r){const t=l.useMemo(()=>r?ir(e):null,[r,e]),[o,n]=l.useState(null);return l.useEffect(()=>{if(!t||!t.needsRecords)return;const u=new AbortController;return Ft("punishments",u.signal).then(({punishmentRecords:i})=>{u.signal.aborted||n({prepared:t,html:t.render(i)})}).catch(i=>{u.signal.aborted||n({prepared:t,html:t.render([],i instanceof Error?i.message:"罚跑记录加载失败")})}),()=>u.abort()},[t]),t?t.needsRecords?o?.prepared===t?o.html:"":t.render([]):e}const cr='.forum-markup .forum-punishment-table{display:table;width:-moz-max-content;width:max-content;min-width:100%;max-width:none;border-collapse:separate;border-spacing:0;transform-origin:top left}.forum-markup .forum-punishment-table :is(th,td){border:0;border-right:1px solid var(--line);border-bottom:1px solid var(--line);padding:9px;background:var(--surface);color:var(--text-muted);font:inherit;text-align:center;white-space:nowrap}.forum-markup .forum-punishment-table tbody tr:hover>td{background:var(--brand-faint, color-mix(in srgb, var(--brand) 8%, var(--surface)))}.forum-markup .forum-punishment-table tr>:last-child{border-right:0}.forum-markup .forum-punishment-table tbody tr:last-child>td{border-bottom:0}.forum-markup .forum-punishment-table th{background:var(--surface-soft);color:var(--text-faint);font-weight:780}.forum-markup .forum-punishment-record{box-sizing:border-box;min-width:0;max-width:100%;border:1px solid var(--line)}.forum-markup .forum-punishment-scroll{max-width:100%;overflow:hidden}.forum-markup .forum-punishment-title{padding:12px 14px;border-bottom:1px solid var(--line);background:var(--surface-soft);color:var(--text-strong);font-family:inherit;font-size:var(--ui-font-size-lg, 14px);font-weight:760;line-height:1.5;text-align:center}.forum-markup .forum-punishment-table .forum-punishment-empty{text-align:center}.forum-markup .forum-punishment-empty>.forum-table-cell-content{width:auto;max-width:none}:root{--surface: #fffefa;--surface-raised: #ffffff;--surface-soft: #f6f8f4;--text: #20231f;--text-strong: #111411;--text-muted: #687068;--text-faint: #919991;--line: #e1e6df;--line-strong: #cdd5cc;--brand: #236b4c;--brand-strong: #174f38;--danger: #b8473f}:root.dark{--surface: #171d19;--surface-raised: #1c241f;--surface-soft: #1f2822;--text: #dde5de;--text-strong: #f6faf6;--text-muted: #a0aca2;--text-faint: #748078;--line: #2c362f;--line-strong: #3c493f;--brand: #69b98d;--brand-strong: #8bcca6;--danger: #ef8178}::-moz-selection{background:color-mix(in srgb,var(--brand) 24%,transparent)}::selection{background:color-mix(in srgb,var(--brand) 24%,transparent)}*,:before,:after{box-sizing:border-box;border-width:0;border-style:solid;border-color:currentcolor}blockquote,figure,h1,h2,h3,h4,h5,h6,hr,p,pre{margin:0}a{color:inherit;text-decoration:inherit}button{margin:0;padding:0;background-color:transparent;color:inherit;font:inherit;letter-spacing:inherit;text-transform:none}button:where(:not([style]):not([class])){min-height:32px;border:1px solid var(--line);border-radius:.5px;padding:4px 12px;background-color:var(--surface);color:var(--text-muted);font-size:14px;font-weight:680;line-height:1.5;vertical-align:middle;cursor:pointer;transition:background-color .14s ease,border-color .14s ease,color .14s ease}button:where(:not([style]):not([class]):hover:not(:disabled)){border-color:var(--line-strong);background-color:var(--surface-soft);color:var(--brand-strong)}button:where(:not([style]):not([class]):focus-visible){outline:2px solid var(--brand);outline-offset:2px}button:where(:not([style]):not([class]):disabled){cursor:not-allowed;opacity:.5}img,svg,video,canvas,audio,iframe,embed,object{display:block;vertical-align:middle}.capubbs-html-frame-root iframe{background-color:transparent!important}img,video{max-width:100%;height:auto}table{border-color:inherit;border-collapse:collapse;text-indent:0}.capubbs-activity-signup-canceled,.capubbs-activity-signup-canceled *{color:var(--danger)!important;text-decoration-color:var(--danger)!important;text-decoration-line:line-through!important;text-decoration-thickness:2px!important}.forum-markup>:first-child{margin-top:0}.forum-markup>:last-child{margin-bottom:0}.forum-markup p,.forum-markup div{margin:0}.forum-markup-floor p{margin:0 0 .75em}.forum-markup-floor>div+div{margin-top:.55em}.forum-markup a{color:var(--brand-strong);font-weight:inherit;text-decoration:underline;text-decoration-thickness:1px;text-underline-offset:.16em}.forum-markup .forum-mention{text-decoration:none}.forum-markup blockquote{margin:0 0 0 2em;border:0;padding:0;background:transparent;color:inherit}.forum-markup blockquote.forum-quote,.forum-markup .forum-legacy-quote,.forum-markup blockquote.capubbs-floor-quote{margin:.8em 0;border-left:3px solid color-mix(in srgb,var(--brand) 38%,var(--line));padding:.55em .75em;background:var(--surface-soft);color:var(--text-muted)}.forum-markup .capubbs-floor-quote-jump{margin-left:.75em}.forum-markup .forum-legacy-quote-content{margin:0}.forum-markup h1,.forum-markup h2,.forum-markup h3,.forum-markup h4,.forum-markup h5,.forum-markup h6{margin:.9rem 0 .45rem;color:var(--brand-strong);font-weight:800;line-height:1.35}.forum-markup h1{font-size:1.45rem}.forum-markup h2{font-size:1.25rem}.forum-markup h3{font-size:1.1rem}.forum-markup h4,.forum-markup h5,.forum-markup h6{font-size:1em}.forum-markup ul,.forum-markup ol{margin:.65em 0;padding-left:1.45em}.forum-markup ul{list-style:disc}.forum-markup ol{list-style:decimal}.forum-markup ol.capubbs-ordered-list-alpha{list-style-type:lower-alpha}.forum-markup ol.capubbs-ordered-list-roman{list-style-type:lower-roman}.forum-markup pre{max-width:100%;overflow-x:auto;margin:.75em 0;border-radius:2px;padding:.75em;background:#182531;color:#f8fafc;white-space:pre-wrap}.forum-markup code,.forum-markup kbd{border-radius:2px;padding:.08em .25em;background:color-mix(in srgb,var(--surface-soft) 75%,var(--line));font-family:SFMono-Regular,Cascadia Code,Consolas,monospace;font-size:.9em}.forum-markup pre code{padding:0;background:transparent;color:inherit}.forum-markup font[size="1"]{font-size:11px}.forum-markup font[size="2"]{font-size:13px}.forum-markup font[size="3"]{font-size:15px}.forum-markup font[size="4"]{font-size:17px}.forum-markup font[size="5"]{font-size:19px}.forum-markup font[size="6"]{font-size:21px}.forum-markup font[size="7"]{font-size:23px}.forum-markup hr{margin:.9em 0;border:0;border-top:1px solid var(--line-strong)}.forum-markup img{display:inline-block;height:auto;max-width:100%;vertical-align:middle}.forum-markup img[data-capubbs-image-width][data-capubbs-image-height]:not([data-capubbs-image-loaded=true]){color:transparent;font-size:0;background-color:color-mix(in srgb,var(--surface-soft) 82%,var(--line));background-image:linear-gradient(105deg,transparent 20%,color-mix(in srgb,var(--surface-raised) 70%,transparent) 45%,transparent 70%);background-size:220% 100%;animation:capubbs-image-loading 1.2s ease-in-out infinite}.forum-markup img[role=button]{cursor:zoom-in}.forum-markup img[role=button]:focus-visible{outline:2px solid var(--brand);outline-offset:3px}.forum-markup table{display:block;max-width:100%;overflow-x:auto;border-collapse:collapse}.forum-markup td,.forum-markup th{border:1px solid var(--line);padding:.35em .5em}.forum-markup-signature{color:#999;font-family:monospace;font-size:14px;line-height:1.6;overflow-wrap:anywhere}:root.dark .forum-markup-signature{color:#666}.forum-markup .capubbs-gallery{position:relative;display:block;width:100%;margin:.9rem 0;overflow:hidden;border:1px solid var(--line);border-radius:2px;background:transparent;color:var(--text)}.forum-markup .capubbs-gallery:focus-visible{outline:2px solid var(--brand);outline-offset:3px}.forum-markup .capubbs-gallery-header{position:relative;display:flex;min-height:44px;align-items:center;justify-content:space-between;gap:12px;margin:0;padding:9px 12px;border-bottom:1px solid var(--line);background:var(--surface-soft)}.forum-markup .capubbs-gallery-title{width:100%;min-width:0;margin:0;color:var(--text-strong);font-size:.82rem;font-weight:760;line-height:1.4;text-align:center}.forum-markup .capubbs-gallery-stage{position:relative;display:block;margin:0;background:transparent}.forum-markup .capubbs-gallery-slide{display:block;margin:0;background:transparent}.forum-markup .capubbs-gallery-slide[data-capubbs-gallery-active=false]{display:none}.forum-markup .capubbs-gallery-slide>img{display:block;width:100%;height:var(--capubbs-gallery-image-height, clamp(280px, 52vw, 560px));max-width:none;margin:0 auto;border-radius:0;-o-object-fit:contain;object-fit:contain}.forum-markup .capubbs-gallery-caption{display:block;margin:0;color:var(--text-muted);font-size:.78rem;line-height:1.55;text-align:center}.forum-markup .capubbs-gallery-caption[data-capubbs-gallery-active=false]{display:none}.forum-markup .capubbs-gallery-footer{position:relative;display:flex;min-height:44px;align-items:center;justify-content:center;margin:0;padding:9px 12px;border-top:1px solid var(--line);background:var(--surface-soft)}.forum-markup .capubbs-gallery-captions{width:100%;min-width:0;margin:0;padding-inline:48px;text-align:center}.forum-markup .capubbs-gallery-count{position:absolute;top:50%;right:12px;color:var(--text-faint);font-size:.72rem;font-variant-numeric:tabular-nums;font-weight:760;line-height:1.25;transform:translateY(-50%)}.forum-markup .capubbs-gallery-count[data-capubbs-gallery-current]:before{content:attr(data-capubbs-gallery-current) "/" attr(data-capubbs-gallery-total)}.forum-markup .capubbs-gallery-nav{position:absolute;z-index:4;top:50%;display:grid;width:36px;height:48px;place-items:center;padding:0;transform:translateY(-50%);border:1px solid rgb(255 255 255 / .25);border-radius:2px;background:#00000080;color:#fff;cursor:pointer;transition:.15s ease}.forum-markup .capubbs-gallery-nav:hover{background:#000000b8}.forum-markup .capubbs-gallery-nav:focus-visible{outline:2px solid #fff;outline-offset:2px}.forum-markup .capubbs-gallery-nav:before{font-family:Arial,sans-serif;font-size:2rem;font-weight:300;line-height:1}.forum-markup .capubbs-gallery-nav-prev:before{content:"‹"}.forum-markup .capubbs-gallery-nav-next:before{content:"›"}.forum-markup .capubbs-gallery-nav-prev{left:10px}.forum-markup .capubbs-gallery-nav-next{right:10px}@keyframes capubbs-image-loading{0%{background-position:120% 0}to{background-position:-80% 0}}@media(max-width:640px){.forum-markup .capubbs-gallery-slide>img{height:var(--capubbs-gallery-image-height, min(72vw, 420px))}.forum-markup .capubbs-gallery-nav{width:32px;height:42px}.forum-markup .capubbs-gallery-nav-prev{left:7px}.forum-markup .capubbs-gallery-nav-next{right:7px}}@media(prefers-reduced-motion:reduce){.forum-markup img[data-capubbs-image-width][data-capubbs-image-height]:not([data-capubbs-image-loaded=true]){animation:none}}',ur="/bbs/new-assets/threadHtmlBootstrap-x4mBAuLM.html";function dr(e,r){const t=new URL(e);return t.pathname=/Android|iPhone|iPad|iPod|Mobile/i.test(r)?"/m/outchain/player":"/outchain/player",t.href}function ke(e,r){try{const t=new URL(e,r);return!(t.hostname==="player.bilibili.com"&&t.pathname==="/player.html"||t.hostname==="music.163.com"&&["/outchain/player","/m/outchain/player"].includes(t.pathname))||!["http:","https:"].includes(t.protocol)||t.username||t.password||t.port?null:(t.protocol="https:",t.href)}catch{return null}}function mr(e,r){const t=new URL(e);return t.hostname==="music.163.com"?(t.searchParams.set("auto","0"),dr(t.href,r)):(t.searchParams.set("autoplay","0"),t.href)}function pr(e){if(!e)return{left:0,top:0};const r=window.getComputedStyle(e);return{left:e.offsetLeft+e.clientLeft+(Number.parseFloat(r.paddingLeft)||0),top:e.offsetTop+e.clientTop+(Number.parseFloat(r.paddingTop)||0)}}function fr(e){if(!e||typeof e!="object")return!1;const r=e;return typeof r.id=="string"&&typeof r.src=="string"&&ke(r.src,"https://music.163.com")===r.src&&["left","top","width","height"].every(t=>{const o=r[t];return typeof o=="number"&&Number.isFinite(o)&&Math.abs(o)<=1e5})&&r.width>0&&r.height>0}const Me=64*1024*1024,le=new Map,de=new Map,ne=new Map;let ve=0,we=0,xe=!1;function te(){xe||!ne.size||(xe=!0,setTimeout(()=>{xe=!1;const e=[];ne.forEach((r,t)=>{const o=r.priorities.map(n=>n());if(o.every(n=>n===null)){ne.delete(t),le.delete(t),r.reject(new DOMException("图片所在内容已卸载","AbortError"));return}e.push({source:t,request:r,priority:o.includes("high")?"high":"low"})}),e.sort((r,t)=>+(t.priority==="high")-+(r.priority==="high"));for(const{source:r,request:t,priority:o}of e){if(ve>=6)break;o==="low"&&we>=2||(ne.delete(r),ve+=1,o==="low"&&(we+=1),t.start(o))}},0))}function Ye(e){return new URL(e,new URL("/bbs/content/",window.location.origin)).href}function gr(e,r=()=>"high"){const t=Ye(e),o=new URL(t);if(o.origin!==window.location.origin||!o.pathname.startsWith("/bbs/images/")&&!o.pathname.startsWith("/bbsimg/"))return Promise.reject(new Error("仅代理论坛图片目录"));const n=le.get(t);if(n)return ne.get(t)?.priorities.push(r),te(),n;const u=new Promise((i,c)=>{ne.set(t,{priorities:[r],reject:c,start:d=>{hr(t,d).then(i,c).finally(()=>{ve-=1,d==="low"&&(we-=1),te()})}})});return le.set(t,u),te(),u}function hr(e,r){return fetch(e,{credentials:"same-origin",referrerPolicy:"no-referrer",priority:r}).then(async t=>{if(!t.ok)throw new Error(`图片加载失败：${t.status}`);if(!(t.headers.get("content-type")?.toLowerCase()??"").startsWith("image/"))throw new Error("图片响应类型无效");const n=Number.parseInt(t.headers.get("content-length")??"",10);if(Number.isFinite(n)&&n>Me)throw new Error("图片大小超出限制");const u=await t.blob();if(u.size>Me)throw new Error("图片大小超出限制");const i={blob:u,objectUrl:URL.createObjectURL(u),sourceUrl:e};return de.set(e,i),i}).catch(t=>{throw le.delete(e),t})}function br(e){try{return de.get(Ye(e))?.objectUrl}catch{return}}typeof window<"u"&&(window.addEventListener("scroll",te,{passive:!0}),window.addEventListener("resize",te),window.addEventListener("pagehide",e=>{e.persisted||(de.forEach(r=>URL.revokeObjectURL(r.objectUrl)),de.clear(),le.clear())}));function yr(e,r,t){return r.some(o=>o.right>o.left&&o.bottom>o.top&&e.top+o.bottom>Math.max(0,e.top)&&e.top+o.top<Math.min(t.height,e.bottom)&&e.left+o.right>Math.max(0,e.left)&&e.left+o.left<Math.min(t.width,e.right))?"high":"low"}const xr=28,vr=64,wr=5e4,Ir=30,Ve=30,$="capubbs-thread-html-frame",Ke=new URL("/bbs/lib/jquery.min.js",window.location.origin).href,Ar=qr(cr),Sr=/\son[a-z][\w:-]*\s*=/i;let ue=null;function $e({className:e="",floor:r,html:t,isActivitySignupCanceled:o=!1,onImageOpen:n,onIsolatedTextSelection:u,variant:i}){const c=l.useMemo(()=>i==="signature"?Mt(t):t,[t,i]),d=Rr(c,i==="signature"),b=lr(d,i==="floor"),s=pt(b),f=l.useMemo(()=>s?null:ft(b,{normalizeLegacyLineBreaks:i==="signature"}),[b,s,i]),g=l.useMemo(()=>gt(b),[b]);return!s&&f!==null?a.jsx(Be,{className:e,html:f,onImageOpen:n,variant:i}):a.jsx(kr,{className:e,floor:r,html:g,isActivitySignupCanceled:o,onImageOpen:n,onTextSelection:u,variant:i})}function kr({className:e,floor:r,html:t,isActivitySignupCanceled:o,onImageOpen:n,onTextSelection:u,variant:i}){const c=l.useRef(null),d=l.useRef(`${i}-${r}-${Math.random().toString(36).slice(2)}`),b=l.useRef(n);b.current=n;const s=l.useRef(u);s.current=u;const f=i==="signature"?xr:vr,g=!!n,[I,y]=l.useState(null),[p,k]=l.useState(null),E=Mr(),S=l.useRef(E),R=bt(),T=i==="signature"?14:R,P=l.useMemo(()=>Lr(jr(t)),[t]),N=P.includes('type="text/capubbs-user-script"')||Sr.test(P),H=l.useMemo(()=>Er({canOpenImages:g,frameId:d.current,needsJquery:N,html:P,isActivitySignupCanceled:o,isDarkTheme:S.current,fontSize:T,variant:i}),[g,P,T,o,N,i]),z=l.useMemo(()=>Math.random().toString(36).slice(2),[H]),X=l.useMemo(()=>`${ur}#${new URLSearchParams({frameId:d.current,token:z})}`,[z]),K=l.useCallback(()=>{c.current?.contentWindow?.postMessage({source:$,type:"document-response",frameId:d.current,token:z,html:H},"*")},[z,H]),Q=l.useCallback(()=>{c.current?.contentWindow?.postMessage({frameId:d.current,source:$,theme:E?"dark":"light",type:"theme"},"*")},[E]),U=l.useCallback((C=c.current?.contentWindow)=>{!N||!C||ze().then(F=>{c.current?.contentWindow===C&&C.postMessage({frameId:d.current,jquerySource:F,source:$,type:"jquery-response"},"*")})},[N]),_=l.useCallback(()=>{K(),Q(),U()},[K,U,Q]);l.useEffect(()=>{y(null)},[X]),l.useEffect(()=>{Q()},[Q]),l.useEffect(()=>{N&&ze()},[N]),l.useLayoutEffect(()=>{te()},[I]),l.useLayoutEffect(()=>{let C=!0;const F=new Map;function ee(A){const Y=c.current?.contentWindow;if(!(!Y||A.source!==Y||!Pr(A.data))&&A.data.frameId===d.current){if(A.data.type==="embedded-player-layout"){k({token:z,players:A.data.players});return}if(A.data.type==="document-request"){A.data.token===z&&K();return}if(A.data.type==="jquery-request"){U(Y);return}if(A.data.type==="image-resource-layout"){F.has(A.data.requestId)&&(F.set(A.data.requestId,A.data.bounds),te());return}if(A.data.type==="image-resource-request"){const L=Y,O=A.data.requestId;F.set(O,A.data.bounds);const j=()=>{const m=c.current;return!C||!m||m.contentWindow!==L?null:yr(m.getBoundingClientRect(),F.get(O)??[],{width:window.innerWidth,height:window.innerHeight})};gr(A.data.url,j).then(m=>{!C||c.current?.contentWindow!==L||L.postMessage({blob:m.blob,priority:j(),frameId:d.current,requestId:A.data.requestId,source:$,type:"image-resource-response"},"*")}).catch(()=>{!C||c.current?.contentWindow!==L||L.postMessage({priority:j(),frameId:d.current,requestId:A.data.requestId,source:$,type:"image-resource-error"},"*")}).finally(()=>F.delete(O));return}if(A.data.type==="anchor"){const L=c.current;if(!L)return;const O=window.getComputedStyle(document.documentElement),j=Number.parseFloat(O.getPropertyValue("--topbar-height"))||0,m=window.scrollY+L.getBoundingClientRect().top;window.scrollTo({left:0,top:Math.max(0,m+A.data.offsetTop-j-16)});return}if(A.data.type==="navigate"){const L=yt(A.data.url,Re());if(!L)return;window.history.pushState(null,"",L),window.dispatchEvent(new Event(xt));const O=new URL(L,window.location.origin);O.hash?window.requestAnimationFrame(()=>{const j=decodeURIComponent(O.hash.slice(1)),m=vt(`#${j}`);(m?wt(m):document.getElementById(j))?.scrollIntoView({block:"start"})}):window.scrollTo({left:0,top:0});return}if(A.data.type==="image-open"){const L=c.current;if(!L)return;const O=Array.from(L.contentDocument?.querySelectorAll("img")??[]),j=A.data.images.map(x=>({...x,element:typeof x.elementIndex=="number"?O[x.elementIndex]:void 0,src:br(x.src)??x.src})),m=x=>{const w=j[x];!w||typeof w.galleryId!="number"||!Number.isSafeInteger(w.galleryIndex)||L.contentWindow?.postMessage({frameId:d.current,galleryId:w.galleryId,galleryIndex:w.galleryIndex,source:$,type:"gallery-select"},"*")};b.current?.(j,A.data.imageIndex,L,m);return}if(A.data.type==="selection"){A.data.text&&window.getSelection()?.removeAllRanges(),s.current?.(A.data.text);return}y(Math.min(wr,Math.max(f,Math.ceil(A.data.height))))}}return window.addEventListener("message",ee),()=>{C=!1,F.clear(),window.removeEventListener("message",ee),te()}},[z,X,f,K,U]);const Z=pr(c.current);return a.jsxs("div",{className:"thread-html-frame-container",children:[a.jsx("iframe",{ref:c,className:`thread-html-frame thread-html-frame-${i} ${e}`.trim(),referrerPolicy:"no-referrer",sandbox:"allow-scripts allow-downloads",scrolling:"no",src:X,onLoad:_,style:{"--thread-html-frame-width-allowance":`${Ve}px`,...I===null?{}:{"--thread-html-frame-height":`${I}px`}},title:i==="signature"?`第 ${r} 楼签名档`:`第 ${r} 楼正文`},z),p?.token===z?p.players.map(C=>a.jsx("iframe",{className:"thread-embedded-player",src:mr(C.src,navigator.userAgent),title:new URL(C.src).hostname==="player.bilibili.com"?"哔哩哔哩播放器":"网易云音乐播放器",allow:"autoplay; fullscreen; picture-in-picture",allowFullScreen:!0,scrolling:"no",style:{left:C.left+Z.left,top:C.top+Z.top,width:C.width,height:C.height}},`${z}-${C.id}`)):null]})}function Rr(e,r){const[t,o]=l.useState(e);return l.useEffect(()=>{const n=new AbortController,u=r?$t(e):[];if(o(e),u.length===0)return()=>n.abort();const i=Array.from(new Map(u.map(c=>[`${c.bid}:${c.tid}:${c.pid}`,c])).values());return Promise.all(i.map(async c=>{try{const d=await ht(c,n.signal);return[`${c.bid}:${c.tid}:${c.pid}`,d]}catch(d){if(d instanceof DOMException&&d.name==="AbortError")throw d;return[`${c.bid}:${c.tid}:${c.pid}`,""]}})).then(c=>{if(n.signal.aborted)return;const d=new Map(c);let b=e;u.forEach(s=>{const f=d.get(`${s.bid}:${s.tid}:${s.pid}`);f&&(b=b.replace(s.marker,f))}),o(b)}).catch(()=>{}),()=>n.abort()},[r,e]),t}function Er({canOpenImages:e,frameId:r,fontSize:t,needsJquery:o,html:n,isActivitySignupCanceled:u,isDarkTheme:i,variant:c}){const d=c==="signature",b=d?"#999999":"rgb(63 63 70)",s=d?"#666666":"rgb(228 228 231)",f=d?"monospace":"'Noto Sans CJK SC','Source Han Sans SC','PingFang SC','Microsoft YaHei',sans-serif",g=d?"padding-top:10px;color:inherit;font-family:inherit;font-size:inherit;":"",I=u?" capubbs-activity-signup-canceled":"";return`<!doctype html>
...
<head>
  ...
  <style>
    ...
    .capubbs-html-frame-root{display:flow-root;width:calc(100% - ${Ve}px);${g}}.capubbs-html-frame-root iframe{display:inline-block;vertical-align:baseline}
  </style>
...
<body><main class="capubbs-html-frame-root forum-markup forum-markup-${c}${I}">${n}</main></body>
    ...
    var preparePunishmentTableFit=${_e.toString()};
    var normalizeEmbeddedPlayerUrl=${ke.toString()};
    ...
    function reportEmbeddedPlayers(){
      ...
      window.parent.postMessage({source:'${$}',type:'embedded-player-layout',frameId:frameId,players:players},'*');
    }
  ...
  }());`}function jr(e){return e.replace(/<script\b([^>]*)>/gi,(r,t)=>`<script${t.replace(/\s+type\s*=\s*(?:"[^"]*"|'[^']*'|[^\s>]+)/gi,"")} type="text/capubbs-user-script">`)}function Lr(e){if(!/<(?:img|iframe)\b/i.test(e))return e;const r=document.createElement("template");return r.innerHTML=e,r.content.querySelectorAll("iframe[src]").forEach(t=>{const o=ke(t.getAttribute("src")??"",Re());o&&(t.dataset.capubbsPlayerSrc=o,t.removeAttribute("src"))}),r.content.querySelectorAll("img[src]").forEach(t=>{const o=t.getAttribute("src")?.trim()??"";!o||/^(?:blob:|data:)/i.test(o)||(t.dataset.capubbsImageResourceSrc=o,t.setAttribute("fetchpriority","low"),t.removeAttribute("src"),t.removeAttribute("srcset"),t.closest("picture")?.querySelectorAll("source[srcset]").forEach(n=>{n.removeAttribute("srcset")}))}),r.innerHTML}function ze(){return ue||(ue=fetch(Ke,{credentials:"same-origin"}).then(e=>{if(!e.ok)throw new Error(`Failed to load jQuery: ${e.status}`);return e.text()}).catch(()=>null),ue)}function Nr(){return["default-src 'none'","script-src 'unsafe-inline' http: https: data: blob:","style-src 'unsafe-inline' http: https:","img-src http: https: data: blob:","media-src http: https: data: blob:","font-src http: https: data: blob:","frame-src http: https: data: blob:","child-src http: https: data: blob:","connect-src 'none'","object-src 'none'","form-action 'none'","upgrade-insecure-requests"].join("; ")}function Re(){return new URL("/bbs/content/",window.location.origin).href}function Tr(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function qr(e){return e.replace(/<\/style/gi,"<\\/style")}function Pr(e){if(!e||typeof e!="object")return!1;const r=e;return r.source!==$||typeof r.frameId!="string"?!1:r.type==="embedded-player-layout"?Array.isArray(r.players)&&r.players.every(fr):r.type==="document-request"?typeof r.token=="string":r.type==="anchor"?typeof r.offsetTop=="number"&&Number.isFinite(r.offsetTop)&&r.offsetTop>=0:r.type==="navigate"?typeof r.url=="string":r.type==="jquery-request"?!0:r.type==="image-resource-request"||r.type==="image-resource-layout"?typeof r.requestId=="string"&&r.requestId.length>0&&Array.isArray(r.bounds)&&r.bounds.every(t=>t&&["top","bottom","left","right"].every(o=>typeof t[o]=="number"&&Number.isFinite(t[o])))&&(r.type==="image-resource-layout"||"url"in r&&typeof r.url=="string"&&r.url.length>0):r.type==="selection"?typeof r.text=="string":r.type==="image-open"?typeof r.imageIndex=="number"&&Number.isSafeInteger(r.imageIndex)&&Array.isArray(r.images)&&r.images.length>0&&r.imageIndex>=0&&r.imageIndex<r.images.length&&r.images.every(t=>!!t&&typeof t=="object"&&typeof t.alt=="string"&&typeof t.elementIndex=="number"&&Number.isSafeInteger(t.elementIndex)&&t.elementIndex>=0&&typeof t.src=="string"&&t.src.length>0&&(t.galleryId===void 0&&t.galleryIndex===void 0||typeof t.galleryId=="number"&&Number.isSafeInteger(t.galleryId)&&t.galleryId>=0&&typeof t.galleryIndex=="number"&&Number.isSafeInteger(t.galleryIndex)&&t.galleryIndex>=0)):r.type==="resize"&&typeof r.height=="number"&&Number.isFinite(r.height)}function Mr(){const[e,r]=l.useState(()=>document.documentElement.classList.contains("dark"));return l.useEffect(()=>{const t=document.documentElement,o=()=>r(t.classList.contains("dark")),n=new MutationObserver(o);return n.observe(t,{attributeFilter:["class"],attributes:!0}),()=>n.disconnect()},[]),e}function $r({attachments:e=[],bodyClassName:r="thread-floor-body",bodyFallback:t=null,bodyHtml:o,floor:n,isActivitySignupCanceled:u=!1,onImageOpen:i,onIsolatedTextSelection:c,signatureClassName:d="thread-signature",signatureHtml:b,signatureText:s}){const f=i?(g,I,y,p)=>{const k=g[I];k&&i([k],0,y,p?()=>p(I):void 0)}:void 0;return a.jsxs(a.Fragment,{children:[o?a.jsx($e,{className:r,floor:n,html:o,isActivitySignupCanceled:u,onImageOpen:i,onIsolatedTextSelection:c,variant:"floor"}):t,a.jsx(zr,{attachments:e}),b?a.jsx($e,{className:d,floor:n,html:b,onImageOpen:f,variant:"signature"}):s?a.jsx("footer",{className:d,children:a.jsx("p",{children:s})}):null]})}function zr({attachments:e}){return e.length===0?null:a.jsxs("section",{"aria-label":"附件",className:"thread-attachments",children:[a.jsxs("header",{className:"thread-attachments-heading",children:[a.jsx(Ut,{"aria-hidden":"true",size:14}),a.jsx("span",{children:"附件"}),a.jsx("small",{children:e.length})]}),a.jsx("ul",{children:e.map(r=>{const t=a.jsxs(a.Fragment,{children:[a.jsx("span",{className:"thread-attachment-name",children:r.name}),a.jsx("small",{children:Dr(r)}),r.exists!==!1&&a.jsx(Et,{"aria-hidden":"true",size:15})]});return a.jsx("li",{children:r.exists===!1?a.jsx("div",{"aria-disabled":"true",className:"thread-attachment-link is-unavailable",children:t}):a.jsx("a",{className:"thread-attachment-link",download:r.name,href:r.downloadHref||`/bbs/download/?id=${encodeURIComponent(r.id)}`,children:t})},r.id)})})]})}function Dr(e){if(e.exists===!1)return"文件不可用";const r=[Fr(e.size),(e.price??0)>0?"付费附件":"免费"];return e.downloadCount!==void 0&&r.push(`下载 ${e.downloadCount} 次`),r.join(" · ")}function Fr(e){if(e<=0)return"大小未知";if(e<1024)return`${e} B`;const r=["KB","MB","GB","TB"];let t=e,o=-1;do t/=1024,o+=1;while(t>=1024&&o<r.length-1);return`${t.toFixed(t>=10?1:2)} ${r[o]}`}function Or({author:e,id:r}){const t=e.tags??[],[o,n]=l.useState(!1),u=l.useRef(null),i=l.useRef(null),c=l.useRef(null),d=l.useRef(null),b=t.map(s=>`${s.id}:${s.name}`).join("|");return l.useLayoutEffect(()=>{if(t.length===0){n(!1);return}const s=()=>{const g=u.current,I=i.current,y=c.current,p=d.current;if(!g||!I||!y||!p||g.offsetWidth===0)return;const k=y.getBoundingClientRect().width,E=p.getBoundingClientRect().width,S=Number.parseFloat(getComputedStyle(I).columnGap)||0,R=I.clientWidth-k-S,T=E>R+1;n(P=>P===T?P:T)};s();const f=new ResizeObserver(s);return[u.current,i.current,d.current].forEach(g=>{g&&f.observe(g)}),()=>f.disconnect()},[b,t.length]),a.jsxs("div",{id:r,ref:u,className:"author-hover-card",role:"dialog","aria-label":`${e.name} 的用户摘要`,children:[a.jsxs("div",{className:"author-card-head",children:[a.jsx("img",{src:e.avatar,alt:""}),a.jsxs("div",{className:"author-card-head-copy",children:[a.jsxs("div",{ref:i,className:"author-card-name-line","data-tags-overflow":o?"true":void 0,children:[a.jsx("strong",{ref:c,children:e.name}),a.jsx("div",{className:"author-card-tag-slot",children:a.jsx(fe,{size:"compact",tags:t})})]}),(e.stars>0||e.role)&&a.jsxs("span",{className:"author-card-status",children:["★".repeat(e.stars),e.stars>0&&e.role?" · ":"",e.role]})]})]}),o?a.jsx("div",{className:"author-card-tags-row",children:a.jsx(fe,{size:"compact",tags:t})}):null,e.medals?.length?a.jsx("div",{className:"author-card-medals",children:a.jsx(He,{medals:e.medals,profileName:e.name,variant:"compact"})}):null,a.jsx("div",{ref:d,className:"author-card-tag-width-measure","aria-hidden":"true",children:a.jsx(fe,{size:"compact",tags:t})}),a.jsxs("dl",{children:[a.jsxs("div",{children:[a.jsx("dt",{children:"主题"}),a.jsx("dd",{children:e.topics})]}),a.jsxs("div",{children:[a.jsx("dt",{children:"回复"}),a.jsx("dd",{children:e.replies})]}),a.jsxs("div",{children:[a.jsx("dt",{children:"签到"}),a.jsx("dd",{children:e.checkins})]})]}),a.jsxs("p",{children:["最近在线：",e.lastSeen]}),a.jsxs("a",{href:ie(e.name),children:["查看个人主页 ",a.jsx(Ot,{size:13})]})]})}function Hr({author:e}){const r=e.tags??[],t=Oe(r),o=ie(e.name);return a.jsxs("aside",{className:"thread-author-profile","aria-label":`${e.name} 的资料`,children:[a.jsx("a",{"aria-label":`查看${e.name}的个人主页`,className:"thread-author-profile-avatar",href:o,children:a.jsx("img",{src:e.avatar,alt:""})}),a.jsx("div",{className:"thread-author-profile-identity",children:a.jsx("a",{href:o,children:e.name})}),(e.stars>0||e.role)&&a.jsxs("div",{className:"thread-author-profile-status",children:[e.stars>0&&a.jsx("span",{"aria-label":`${e.stars} 星`,children:"★".repeat(e.stars)}),e.role&&a.jsx("strong",{children:e.role})]}),a.jsx(Ge,{tags:t}),a.jsx(He,{medals:e.medals??[],profileName:e.name,variant:"compact"}),a.jsxs("dl",{className:"thread-author-profile-stats",children:[a.jsxs("div",{children:[a.jsx("dt",{children:"主题"}),a.jsx("dd",{children:e.topics})]}),a.jsxs("div",{children:[a.jsx("dt",{children:"回复"}),a.jsx("dd",{children:e.replies})]}),a.jsxs("div",{children:[a.jsx("dt",{children:"签到"}),a.jsx("dd",{children:e.checkins})]})]}),a.jsxs("p",{className:"thread-author-profile-last-seen",children:[a.jsx("span",{children:"最近在线"}),a.jsx("strong",{children:e.lastSeen})]})]})}function Ie(e){return e.replace(/^(\d{4})年(\d{2})月(\d{2})日\s+(\d{2})时(\d{2})分(\d{2})秒$/,"$1-$2-$3 $4:$5:$6")}function Gr(e){const r=window.getSelection()?.toString();r&&(e.preventDefault(),e.clipboardData.setData("text/plain",r))}function Ur({articleAfterContent:e,author:r,avatarRail:t,className:o="",content:n,decorationImageSrc:u,editedAt:i,floor:c,floorIndex:d,id:b,inlineAvatar:s=!1,mainAfterContent:f,onCopy:g,publishedAt:I,showAuthorProfile:y}){const p=r.tags??[],k=Oe(p);return a.jsxs("article",{className:`thread-floor${y?" thread-floor-with-author-profile":""}${o?` ${o}`:""}`,"data-floor":c,id:b,onCopy:g,children:[u&&a.jsx("span",{"aria-hidden":"true",className:"thread-floor-decoration",children:a.jsx("img",{alt:"",src:u})}),y?a.jsx(Hr,{author:r}):!s&&t,a.jsxs("div",{className:"thread-floor-main",children:[a.jsxs("header",{className:"thread-floor-header",children:[!y&&s&&t,a.jsxs("div",{className:"thread-floor-author",children:[a.jsx("a",{href:ie(r.name),children:r.name}),a.jsx(Ge,{tags:k})]}),a.jsxs("div",{className:"thread-floor-time",children:[a.jsx("time",{children:Ie(I)}),i&&a.jsxs(a.Fragment,{children:[a.jsx("span",{children:"·"}),a.jsxs("time",{children:["编辑于 ",Ie(i)]})]})]}),d]}),y?a.jsx("div",{className:"thread-floor-content",children:n}):n,f]}),e]})}function _r({canDelete:e,canEdit:r,canQuote:t,canReply:o,decorative:n=!1,deleting:u=!1,editHref:i="",onDelete:c,onQuote:d,onReply:b}){const s=n?-1:void 0,f=l.useRef(null);return a.jsxs("div",{"aria-hidden":n||void 0,className:`thread-floor-actions${n?" thread-floor-actions-decorative":""}`,children:[t&&a.jsxs("button",{onClick:g=>{const I=f.current?f.current.text:De(g.currentTarget);f.current=null,d?.(I)},onPointerDown:g=>{g.button===0&&(f.current={text:De(g.currentTarget)})},tabIndex:s,type:"button",children:[a.jsx(Lt,{size:15}),"引用"]}),o&&a.jsxs("button",{onClick:b,tabIndex:s,type:"button",children:[a.jsx(Bt,{size:15}),"回复"]}),r&&(n?a.jsxs("button",{tabIndex:-1,type:"button",children:[a.jsx(qe,{size:15}),"编辑"]}):a.jsxs("a",{href:i,children:[a.jsx(qe,{size:15}),"编辑"]})),e&&a.jsxs("button",{"aria-busy":u||void 0,className:"floor-action-danger",disabled:!n&&u,onClick:n?void 0:g=>c?.(g.currentTarget),tabIndex:s,type:"button",children:[a.jsx(Se,{size:15}),u?"删除中":"删除"]})]})}function oa({canQuote:e,canReply:r,decorationImageSrc:t,editHref:o,floor:n,isActivityThread:u,isMainPost:i,inlineAvatar:c,showAuthorProfile:d,hideSignature:b,onDeleteFloor:s,onDeleteNestedReply:f,onIsolatedTextSelection:g,onQuote:I,onSubmitNestedReply:y,viewer:p}){const[k,E]=l.useState(!1),[S,R]=l.useState(null),[T,P]=l.useState([]),[N,H]=l.useState(""),[z,X]=l.useState(!1),[K,Q]=l.useState([]),[U,_]=l.useState(""),[Z,C]=l.useState(""),[F,ee]=l.useState(null),[A,Y]=l.useState(""),[L,O]=l.useState(!1),[j,m]=l.useState(void 0),x=Vt(U),w=`nested-reply-count-${n.id}`,[M,B]=l.useState(null),[q,V]=l.useState(!1),oe=l.useRef(null),v=l.useRef(null),W=l.useRef(null),re=l.useRef(null),se=l.useRef(null),ae=l.useMemo(()=>[...n.nestedReplies??[],...K].filter(h=>!T.includes(h.id)),[T,n.nestedReplies,K]),Ee=u&&!i&&/<\s*(?:s|strike)\b/i.test(n.contentHtml??""),Ce=`thread-floor-body${Ee?" capubbs-activity-signup-canceled":""}`;l.useEffect(()=>()=>{v.current!==null&&window.clearTimeout(v.current)},[]),l.useEffect(()=>{if(!q)return;function h(D){oe.current?.contains(D.target)||V(!1)}return document.addEventListener("pointerdown",h),()=>document.removeEventListener("pointerdown",h)},[q]);async function Je(){const h=`${window.location.origin}${window.location.pathname}${window.location.search}#${n.floor}`;await Wt(h)&&(E(!0),v.current!==null&&window.clearTimeout(v.current),v.current=window.setTimeout(()=>E(!1),1800))}const je=(h,D,J,me)=>{se.current=J,B({imageIndex:D,images:h,onImageChange:me})};function Xe(h){M?.onImageChange?.(h),B(null),window.requestAnimationFrame(()=>se.current?.focus())}function Le(h=null){m(h),_(""),C(""),Y(""),window.requestAnimationFrame(()=>re.current?.focus())}function Ne(){m(void 0),_(""),Y("")}async function Qe(h){h.preventDefault();const D=U.trim();if(!(!x.canSubmit||!p||!r||L)){O(!0),Y("");try{const J=await y(n,j??null,D);Q(me=>[...me,{author:p,canDelete:!0,content:D,id:J>0?String(J):`local-${n.id}-${Date.now()}`,publishedAt:Yr(new Date),target:j??void 0}]),Ne()}catch(J){Y(J instanceof Error?J.message:"楼中楼回复发布失败，请稍后重试。")}finally{O(!1)}}}async function Ze(h){ee(h.id),C("");try{await f(n,h),P(D=>[...D,h.id]),Q(D=>D.filter(J=>J.id!==h.id)),R(null)}catch(D){C(D instanceof Error?D.message:"楼中楼删除失败，请稍后重试。")}finally{ee(null)}}async function et(){if(!z){X(!0),H("");try{await s(n)}catch(h){H(h instanceof Error?h.message:"楼层删除失败，请稍后重试。"),X(!1)}}}function tt(){R(null),H(""),C(""),window.requestAnimationFrame(()=>W.current?.focus())}function rt(){if(!S)return;const h=S;R(null),h.kind==="floor"?et():Ze(h.reply)}const at=a.jsxs("div",{className:`thread-avatar-rail${q?" thread-avatar-rail-open":""}`,ref:oe,children:[a.jsx("button",{"aria-controls":`author-card-${n.floor}`,"aria-expanded":q,"aria-label":`查看${n.author.name}的资料卡`,className:"thread-avatar-button",onClick:()=>V(h=>!h),type:"button",children:a.jsx("img",{src:n.author.avatar,alt:""})}),a.jsx(Or,{author:n.author,id:`author-card-${n.floor}`})]}),nt=a.jsx($r,{attachments:n.attachments,bodyFallback:a.jsx("div",{className:Ce,children:n.paragraphs.map(h=>a.jsx("p",{children:h},h))}),bodyClassName:Ce,bodyHtml:n.contentHtml,floor:n.floor,isActivitySignupCanceled:Ee,onImageOpen:je,onIsolatedTextSelection:h=>g(n,h),signatureHtml:b?void 0:n.signatureHtml,signatureText:b?void 0:n.signature}),ot=a.jsxs("button",{"aria-label":`复制第 ${n.floor} 楼链接`,className:"thread-floor-index",onClick:Je,title:"复制楼层链接",type:"button",children:["#",n.floor]}),st=a.jsxs(a.Fragment,{children:[a.jsx(_r,{canDelete:(!u||i)&&(n.canDelete??n.isOwn??!1),canEdit:(!u||i)&&!!n.isOwn,canQuote:e,canReply:r,deleting:z,editHref:o,onDelete:h=>{W.current=h,H(""),R({kind:"floor"})},onQuote:h=>I(n,h),onReply:()=>Le()}),N&&a.jsx("p",{className:"thread-floor-delete-error",role:"alert",children:N}),ae.length>0&&a.jsx("section",{className:"nested-replies","aria-label":`${n.floor} 楼的楼中楼回复`,children:ae.map(h=>a.jsxs("article",{children:[a.jsx("img",{src:h.author.avatar,alt:""}),a.jsxs("div",{className:"nested-reply-main",children:[a.jsxs("div",{className:"nested-reply-identity",children:[a.jsx("a",{className:"nested-reply-author",href:ie(h.author.name),children:h.author.name}),h.target&&a.jsxs("span",{className:"nested-reply-target",children:[" ","回复"," ",a.jsx("a",{className:"nested-reply-author",href:ie(h.target),children:h.target})]})]}),h.contentHtml?a.jsx(Be,{className:"nested-reply-content",html:h.contentHtml,onImageOpen:je,variant:"nested"}):a.jsx("p",{children:h.content}),a.jsxs("footer",{className:"nested-reply-footer",children:[a.jsx("time",{children:Ie(h.publishedAt)}),r&&a.jsx("button",{onClick:()=>Le(h.author.name),type:"button",children:"回复"}),h.canDelete&&a.jsxs("button",{className:"nested-reply-delete",disabled:F===h.id,onClick:D=>{W.current=D.currentTarget,C(""),R({kind:"nested",reply:h})},type:"button",children:[a.jsx(Se,{size:12}),F===h.id?"删除中":"删除"]})]})]})]},h.id))}),Z&&a.jsx("p",{className:"nested-reply-delete-error",role:"alert",children:Z}),j!==void 0&&r&&a.jsxs("form",{className:"nested-reply-composer",onSubmit:Qe,children:[a.jsxs("div",{className:"nested-reply-input-field",children:[a.jsx("textarea",{"aria-describedby":w,"aria-invalid":x.isOverLimit||void 0,"aria-label":j?`回复 @${j}`:`回复第 ${n.floor} 楼`,onChange:h=>{_(h.target.value),Y("")},placeholder:j?`回复 @${j}`:"写一条楼中楼回复",ref:re,rows:2,value:U}),a.jsxs("small",{"aria-label":`已输入 ${x.length} 字，最多 ${x.limit} 字`,className:`nested-reply-character-count${x.isOverLimit?" nested-reply-character-count-error":""}`,id:w,children:[x.length," / ",x.limit]})]}),a.jsxs("div",{className:"nested-reply-composer-actions",children:[a.jsx("button",{"aria-label":"取消楼中楼回复",className:"nested-reply-cancel",disabled:L,onClick:Ne,type:"button",children:a.jsx(Ae,{size:15})}),a.jsxs("button",{className:"nested-reply-submit",disabled:!x.canSubmit||L,type:"submit",children:[a.jsx(Ct,{size:14}),L?"发送中":"发送"]})]}),A&&a.jsx("p",{className:"nested-reply-error",role:"alert",children:A})]})]}),it=a.jsxs(a.Fragment,{children:[k&&a.jsxs("div",{"aria-live":"polite",className:"copy-floor-toast",role:"status",children:[a.jsx(jt,{"aria-hidden":"true",size:15}),"已复制楼层链接"]}),M&&a.jsx(or,{images:M.images,initialImageIndex:M.imageIndex,onImageChange:M.onImageChange,onClose:Xe}),S&&a.jsx(Br,{floor:n,isMainPost:i,onCancel:tt,onConfirm:rt,target:S})]});return a.jsx(Ur,{articleAfterContent:it,author:n.author,avatarRail:at,content:nt,decorationImageSrc:t,editedAt:n.editedAt,floor:n.floor,floorIndex:ot,id:String(n.floor),inlineAvatar:c,mainAfterContent:st,onCopy:Gr,publishedAt:n.publishedAt,showAuthorProfile:d})}function De(e){const r=e.closest(".thread-floor")?.querySelector(".thread-floor-body");return Nt(window.getSelection(),r??null)}function Br({floor:e,isMainPost:r,onCancel:t,onConfirm:o,target:n}){const u=n.kind==="nested"?n.reply:null,i=u?"删除楼中楼回复":r?"删除主楼":"删除回复",c=u?"":r?"删除主楼后，下一楼将顺位成为主楼；如果没有其他回复，整个主题会被删除。":"删除后，该楼内容将移入回收站，后续楼层编号会顺次调整。",d=u?.author.name??e.author.name,b=u?`#${e.floor} · 楼中楼`:`#${e.floor}`,s=Wr(u?.content||e.quoteText||e.paragraphs[0]||"");return l.useEffect(()=>(document.body.classList.add("thread-delete-dialog-open"),()=>document.body.classList.remove("thread-delete-dialog-open")),[]),l.useEffect(()=>{function f(g){g.key==="Escape"&&t()}return document.addEventListener("keydown",f),()=>document.removeEventListener("keydown",f)},[t]),a.jsx("div",{className:"thread-delete-dialog-backdrop",onMouseDown:f=>{f.currentTarget===f.target&&t()},role:"presentation",children:a.jsxs("section",{"aria-describedby":c?"thread-delete-dialog-description":void 0,"aria-labelledby":"thread-delete-dialog-title","aria-modal":"true",className:"thread-delete-dialog",role:"dialog",children:[a.jsxs("header",{children:[a.jsx("span",{className:"thread-delete-dialog-icon","aria-hidden":"true",children:a.jsx(Ht,{size:19})}),a.jsx("div",{children:a.jsx("h2",{id:"thread-delete-dialog-title",children:i})}),a.jsx("button",{"aria-label":"关闭删除确认",onClick:t,type:"button",children:a.jsx(Ae,{size:18})})]}),a.jsxs("div",{className:"thread-delete-dialog-body",children:[c&&a.jsx("p",{id:"thread-delete-dialog-description",children:c}),a.jsxs("div",{className:"thread-delete-dialog-target",children:[a.jsxs("span",{children:[d," · ",b]}),a.jsx("p",{children:s||"此回复没有可预览的文字内容。"})]})]}),a.jsxs("footer",{children:[a.jsx("button",{autoFocus:!0,className:"thread-delete-dialog-cancel",onClick:t,type:"button",children:"取消"}),a.jsxs("button",{className:"thread-delete-dialog-confirm",onClick:o,type:"button",children:[a.jsx(Se,{size:15}),"确认删除"]})]})]})})}function Wr(e){const r=e.replace(/\s+/g," ").trim();return r.length>100?`${r.slice(0,100).trimEnd()}…`:r}function Yr(e){const r=t=>String(t).padStart(2,"0");return`${e.getFullYear()}-${r(e.getMonth()+1)}-${r(e.getDate())} ${r(e.getHours())}:${r(e.getMinutes())}:${r(e.getSeconds())}`}export{Ut as P,$r as T,Ur as a,_r as b,oa as c,na as f,Wt as w};
