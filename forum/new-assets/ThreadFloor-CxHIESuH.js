...
<body><main class="capubbs-html-frame-root forum-markup forum-markup-${c}${I}">${n}</main></body>
    ...
    var normalizeNetEasePlayerUrl=${Se.toString()};
  ...
  }());`}function br(e){return e.replace(/<script\b([^>]*)>/gi,(r,a)=>`<script${a.replace(/\s+type\s*=\s*(?:"[^"]*"|'[^']*'|[^\s>]+)/gi,"")} type="text/capubbs-user-script">`)}function yr(e){if(!/<(?:img|iframe)\b/i.test(e))return e;const r=document.createElement("template");return r.innerHTML=e,r.content.querySelectorAll("iframe[src]").forEach(a=>{const o=Se(a.getAttribute("src")??"",Re());o&&(a.dataset.capubbsNeteaseSrc=o,a.removeAttribute("src"))}),r.content.querySelectorAll("img[src]").forEach(a=>{const o=a.getAttribute("src")?.trim()??"";!o||/^(?:blob:|data:)/i.test(o)||(a.dataset.capubbsImageResourceSrc=o,a.setAttribute("fetchpriority","low"),a.removeAttribute("src"),a.removeAttribute("srcset"),a.closest("picture")?.querySelectorAll("source[srcset]").forEach(n=>{n.removeAttribute("srcset")}))}),r.innerHTML}function Me(){return ue||(ue=fetch(Be,{credentials:"same-origin"}).then(e=>{if(!e.ok)throw new Error(`Failed to load jQuery: ${e.status}`);return e.text()}).catch(()=>null),ue)}function xr(){return["default-src 'none'","script-src 'unsafe-inline' http: https: data: blob:","style-src 'unsafe-inline' http: https:","img-src http: https: data: blob:","media-src http: https: data: blob:","font-src http: https: data: blob:","frame-src http: https: data: blob:","child-src http: https: data: blob:","connect-src 'none'","object-src 'none'","form-action 'none'","upgrade-insecure-requests"].join("; ")}function Re(){return new URL("/bbs/content/",window.location.origin).href}function vr(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function wr(e){return e.replace(/<\/style/gi,"<\\/style")}function Ir(e){if(!e||typeof e!="object")return!1;const r=e;return r.source!==$||typeof r.frameId!="string"?!1:r.type==="netease-layout"?Array.isArray(r.players)&&r.players.every(rr):r.type==="document-request"?typeof r.token=="string":r.type==="anchor"?typeof r.offsetTop=="number"&&Number.isFinite(r.offsetTop)&&r.offsetTop>=0:r.type==="navigate"?typeof r.url=="string":r.type==="jquery-request"?!0:r.type==="image-resource-request"||r.type==="image-resource-layout"?typeof r.requestId=="string"&&r.requestId.length>0&&Array.isArray(r.bounds)&&r.bounds.every(a=>a&&["top","bottom","left","right"].every(o=>typeof a[o]=="number"&&Number.isFinite(a[o])))&&(r.type==="image-resource-layout"||"url"in r&&typeof r.url=="string"&&r.url.length>0):r.type==="selection"?typeof r.text=="string":r.type==="image-open"?typeof r.imageIndex=="number"&&Number.isSafeInteger(r.imageIndex)&&Array.isArray(r.images)&&r.images.length>0&&r.imageIndex>=0&&r.imageIndex<r.images.length&&r.images.every(a=>!!a&&typeof a=="object"&&typeof a.alt=="string"&&typeof a.elementIndex=="number"&&Number.isSafeInteger(a.elementIndex)&&a.elementIndex>=0&&typeof a.src=="string"&&a.src.length>0&&(a.galleryId===void 0&&a.galleryIndex===void 0||typeof a.galleryId=="number"&&Number.isSafeInteger(a.galleryId)&&a.galleryId>=0&&typeof a.galleryIndex=="number"&&Number.isSafeInteger(a.galleryIndex)&&a.galleryIndex>=0)):r.type==="resize"&&typeof r.height=="number"&&Number.isFinite(r.height)}function Ar(){const[e,r]=i.useState(()=>document.documentElement.classList.contains("dark"));return i.useEffect(()=>{const a=document.documentElement,o=()=>r(a.classList.contains("dark")),n=new MutationObserver(o);return n.observe(a,{attributeFilter:["class"],attributes:!0}),()=>n.disconnect()},[]),e}function kr({attachments:e=[],bodyClassName:r="thread-floor-body",bodyFallback:a=null,bodyHtml:o,floor:n,isActivitySignupCanceled:d=!1,onImageOpen:l,onIsolatedTextSelection:c,signatureClassName:g="thread-signature",signatureHtml:y,signatureText:s}){const f=l?(h,I,x,k)=>{const z=h[I];z&&l([z],0,x,k?()=>k(I):void 0)}:void 0;return t.jsxs(t.Fragment,{children:[o?t.jsx(Le,{className:r,floor:n,html:o,isActivitySignupCanceled:d,onImageOpen:l,onIsolatedTextSelection:c,variant:"floor"}):a,t.jsx(Sr,{attachments:e}),y?t.jsx(Le,{className:g,floor:n,html:y,onImageOpen:f,variant:"signature"}):s?t.jsx("footer",{className:g,children:t.jsx("p",{children:s})}):null]})}function Sr({attachments:e}){return e.length===0?null:t.jsxs("section",{"aria-label":"附件",className:"thread-attachments",children:[t.jsxs("header",{className:"thread-attachments-heading",children:[t.jsx(Ft,{"aria-hidden":"true",size:14}),t.jsx("span",{children:"附件"}),t.jsx("small",{children:e.length})]}),t.jsx("ul",{children:e.map(r=>{const a=t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"thread-attachment-name",children:r.name}),t.jsx("small",{children:Rr(r)}),r.exists!==!1&&t.jsx(At,{"aria-hidden":"true",size:15})]});return t.jsx("li",{children:r.exists===!1?t.jsx("div",{"aria-disabled":"true",className:"thread-attachment-link is-unavailable",children:a}):t.jsx("a",{className:"thread-attachment-link",download:r.name,href:r.downloadHref||`/bbs/download/?id=${encodeURIComponent(r.id)}`,children:a})},r.id)})})]})}function Rr(e){if(e.exists===!1)return"文件不可用";const r=[Cr(e.size),(e.price??0)>0?"付费附件":"免费"];return e.downloadCount!==void 0&&r.push(`下载 ${e.downloadCount} 次`),r.join(" · ")}function Cr(e){if(e<=0)return"大小未知";if(e<1024)return`${e} B`;const r=["KB","MB","GB","TB"];let a=e,o=-1;do a/=1024,o+=1;while(a>=1024&&o<r.length-1);return`${a.toFixed(a>=10?1:2)} ${r[o]}`}function jr({author:e,id:r}){const a=e.tags??[],[o,n]=i.useState(!1),d=i.useRef(null),l=i.useRef(null),c=i.useRef(null),g=i.useRef(null),y=a.map(s=>`${s.id}:${s.name}`).join("|");return i.useLayoutEffect(()=>{if(a.length===0){n(!1);return}const s=()=>{const h=d.current,I=l.current,x=c.current,k=g.current;if(!h||!I||!x||!k||h.offsetWidth===0)return;const z=x.getBoundingClientRect().width,q=k.getBoundingClientRect().width,C=Number.parseFloat(getComputedStyle(I).columnGap)||0,A=I.clientWidth-z-C,N=q>A+1;n(T=>T===N?T:N)};s();const f=new ResizeObserver(s);return[d.current,l.current,g.current].forEach(h=>{h&&f.observe(h)}),()=>f.disconnect()},[y,a.length]),t.jsxs("div",{id:r,ref:d,className:"author-hover-card",role:"dialog","aria-label":`${e.name} 的用户摘要`,children:[t.jsxs("div",{className:"author-card-head",children:[t.jsx("img",{src:e.avatar,alt:""}),t.jsxs("div",{className:"author-card-head-copy",children:[t.jsxs("div",{ref:l,className:"author-card-name-line","data-tags-overflow":o?"true":void 0,children:[t.jsx("strong",{ref:c,children:e.name}),t.jsx("div",{className:"author-card-tag-slot",children:t.jsx(fe,{size:"compact",tags:a})})]}),(e.stars>0||e.role)&&t.jsxs("span",{className:"author-card-status",children:["★".repeat(e.stars),e.stars>0&&e.role?" · ":"",e.role]})]})]}),o?t.jsx("div",{className:"author-card-tags-row",children:t.jsx(fe,{size:"compact",tags:a})}):null,e.medals?.length?t.jsx("div",{className:"author-card-medals",children:t.jsx(Fe,{medals:e.medals,profileName:e.name,variant:"compact"})}):null,t.jsx("div",{ref:g,className:"author-card-tag-width-measure","aria-hidden":"true",children:t.jsx(fe,{size:"compact",tags:a})}),t.jsxs("dl",{children:[t.jsxs("div",{children:[t.jsx("dt",{children:"主题"}),t.jsx("dd",{children:e.topics})]}),t.jsxs("div",{children:[t.jsx("dt",{children:"回复"}),t.jsx("dd",{children:e.replies})]}),t.jsxs("div",{children:[t.jsx("dt",{children:"签到"}),t.jsx("dd",{children:e.checkins})]})]}),t.jsxs("p",{children:["最近在线：",e.lastSeen]}),t.jsxs("a",{href:se(e.name),children:["查看个人主页 ",t.jsx(Pt,{size:13})]})]})}function Er({author:e}){const r=e.tags??[],a=ze(r),o=se(e.name);return t.jsxs("aside",{className:"thread-author-profile","aria-label":`${e.name} 的资料`,children:[t.jsx("a",{"aria-label":`查看${e.name}的个人主页`,className:"thread-author-profile-avatar",href:o,children:t.jsx("img",{src:e.avatar,alt:""})}),t.jsx("div",{className:"thread-author-profile-identity",children:t.jsx("a",{href:o,children:e.name})}),(e.stars>0||e.role)&&t.jsxs("div",{className:"thread-author-profile-status",children:[e.stars>0&&t.jsx("span",{"aria-label":`${e.stars} 星`,children:"★".repeat(e.stars)}),e.role&&t.jsx("strong",{children:e.role})]}),t.jsx(De,{tags:a}),t.jsx(Fe,{medals:e.medals??[],profileName:e.name,variant:"compact"}),t.jsxs("dl",{className:"thread-author-profile-stats",children:[t.jsxs("div",{children:[t.jsx("dt",{children:"主题"}),t.jsx("dd",{children:e.topics})]}),t.jsxs("div",{children:[t.jsx("dt",{children:"回复"}),t.jsx("dd",{children:e.replies})]}),t.jsxs("div",{children:[t.jsx("dt",{children:"签到"}),t.jsx("dd",{children:e.checkins})]})]}),t.jsxs("p",{className:"thread-author-profile-last-seen",children:[t.jsx("span",{children:"最近在线"}),t.jsx("strong",{children:e.lastSeen})]})]})}function Ie(e){return e.replace(/^(\d{4})年(\d{2})月(\d{2})日\s+(\d{2})时(\d{2})分(\d{2})秒$/,"$1-$2-$3 $4:$5:$6")}function Nr(e){const r=window.getSelection()?.toString();r&&(e.preventDefault(),e.clipboardData.setData("text/plain",r))}function Tr({articleAfterContent:e,author:r,avatarRail:a,className:o="",content:n,decorationImageSrc:d,editedAt:l,floor:c,floorIndex:g,id:y,inlineAvatar:s=!1,mainAfterContent:f,onCopy:h,publishedAt:I,showAuthorProfile:x}){const k=r.tags??[],z=ze(k);return t.jsxs("article",{className:`thread-floor${x?" thread-floor-with-author-profile":""}${o?` ${o}`:""}`,"data-floor":c,id:y,onCopy:h,children:[d&&t.jsx("span",{"aria-hidden":"true",className:"thread-floor-decoration",children:t.jsx("img",{alt:"",src:d})}),x?t.jsx(Er,{author:r}):!s&&a,t.jsxs("div",{className:"thread-floor-main",children:[t.jsxs("header",{className:"thread-floor-header",children:[!x&&s&&a,t.jsxs("div",{className:"thread-floor-author",children:[t.jsx("a",{href:se(r.name),children:r.name}),t.jsx(De,{tags:z})]}),t.jsxs("div",{className:"thread-floor-time",children:[t.jsx("time",{children:Ie(I)}),l&&t.jsxs(t.Fragment,{children:[t.jsx("span",{children:"·"}),t.jsxs("time",{children:["编辑于 ",Ie(l)]})]})]}),g]}),x?t.jsx("div",{className:"thread-floor-content",children:n}):n,f]}),e]})}function qr({canDelete:e,canEdit:r,canQuote:a,canReply:o,decorative:n=!1,deleting:d=!1,editHref:l="",onDelete:c,onQuote:g,onReply:y}){const s=n?-1:void 0,f=i.useRef(null);return t.jsxs("div",{"aria-hidden":n||void 0,className:`thread-floor-actions${n?" thread-floor-actions-decorative":""}`,children:[a&&t.jsxs("button",{onClick:h=>{const I=f.current?f.current.text:Pe(h.currentTarget);f.current=null,g?.(I)},onPointerDown:h=>{h.button===0&&(f.current={text:Pe(h.currentTarget)})},tabIndex:s,type:"button",children:[t.jsx(Rt,{size:15}),"引用"]}),o&&t.jsxs("button",{onClick:y,tabIndex:s,type:"button",children:[t.jsx(Ot,{size:15}),"回复"]}),r&&(n?t.jsxs("button",{tabIndex:-1,type:"button",children:[t.jsx(Te,{size:15}),"编辑"]}):t.jsxs("a",{href:l,children:[t.jsx(Te,{size:15}),"编辑"]})),e&&t.jsxs("button",{"aria-busy":d||void 0,className:"floor-action-danger",disabled:!n&&d,onClick:n?void 0:h=>c?.(h.currentTarget),tabIndex:s,type:"button",children:[t.jsx(ke,{size:15}),d?"删除中":"删除"]})]})}function Br({canQuote:e,canReply:r,decorationImageSrc:a,editHref:o,floor:n,isActivityThread:d,isMainPost:l,inlineAvatar:c,showAuthorProfile:g,hideSignature:y,onDeleteFloor:s,onDeleteNestedReply:f,onIsolatedTextSelection:h,onQuote:I,onSubmitNestedReply:x,viewer:k}){const[z,q]=i.useState(!1),[C,A]=i.useState(null),[N,T]=i.useState([]),[E,H]=i.useState(""),[F,X]=i.useState(!1),[J,Q]=i.useState([]),[_,B]=i.useState(""),[Z,S]=i.useState(""),[D,ee]=i.useState(null),[w,Y]=i.useState(""),[j,O]=i.useState(!1),[R,u]=i.useState(void 0),[p,v]=i.useState(null),[L,W]=i.useState(!1),M=i.useRef(null),G=i.useRef(null),re=i.useRef(null),b=i.useRef(null),V=i.useRef(null),ae=i.useMemo(()=>[...n.nestedReplies??[],...J].filter(m=>!N.includes(m.id)),[N,n.nestedReplies,J]),ie=d&&!l&&/<\s*(?:s|strike)\b/i.test(n.contentHtml??""),ne=`thread-floor-body${ie?" capubbs-activity-signup-canceled":""}`;i.useEffect(()=>()=>{G.current!==null&&window.clearTimeout(G.current)},[]),i.useEffect(()=>{if(!L)return;function m(P){M.current?.contains(P.target)||W(!1)}return document.addEventListener("pointerdown",m),()=>document.removeEventListener("pointerdown",m)},[L]);async function We(){const m=`${window.location.origin}${window.location.pathname}${window.location.search}#${n.floor}`;await Ht(m)&&(q(!0),G.current!==null&&window.clearTimeout(G.current),G.current=window.setTimeout(()=>q(!1),1800))}const Ce=(m,P,K,ge)=>{V.current=K,v({imageIndex:P,images:m,onImageChange:ge})};function Ye(m){p?.onImageChange?.(m),v(null),window.requestAnimationFrame(()=>V.current?.focus())}function je(m=null){u(m),B(""),S(""),Y(""),window.requestAnimationFrame(()=>b.current?.focus())}function Ee(){u(void 0),B(""),Y("")}async function Ve(m){m.preventDefault();const P=_.trim();if(!(!P||!k||j)){O(!0),Y("");try{const K=await x(n,R??null,P);Q(ge=>[...ge,{author:k,canDelete:!0,content:P,id:K>0?String(K):`local-${n.id}-${Date.now()}`,publishedAt:Pr(new Date),target:R??void 0}]),Ee()}catch(K){Y(K instanceof Error?K.message:"楼中楼回复发布失败，请稍后重试。")}finally{O(!1)}}}async function Je(m){ee(m.id),S("");try{await f(n,m),T(P=>[...P,m.id]),Q(P=>P.filter(K=>K.id!==m.id)),A(null)}catch(P){S(P instanceof Error?P.message:"楼中楼删除失败，请稍后重试。")}finally{ee(null)}}async function Ke(){if(!F){X(!0),H("");try{await s(n)}catch(m){H(m instanceof Error?m.message:"楼层删除失败，请稍后重试。"),X(!1)}}}function Xe(){A(null),H(""),S(""),window.requestAnimationFrame(()=>re.current?.focus())}function Qe(){if(!C)return;const m=C;A(null),m.kind==="floor"?Ke():Je(m.reply)}const Ze=t.jsxs("div",{className:`thread-avatar-rail${L?" thread-avatar-rail-open":""}`,ref:M,children:[t.jsx("button",{"aria-controls":`author-card-${n.floor}`,"aria-expanded":L,"aria-label":`查看${n.author.name}的资料卡`,className:"thread-avatar-button",onClick:()=>W(m=>!m),type:"button",children:t.jsx("img",{src:n.author.avatar,alt:""})}),t.jsx(jr,{author:n.author,id:`author-card-${n.floor}`})]}),et=t.jsx(kr,{attachments:n.attachments,bodyFallback:t.jsx("div",{className:ne,children:n.paragraphs.map(m=>t.jsx("p",{children:m},m))}),bodyClassName:ne,bodyHtml:n.contentHtml,floor:n.floor,isActivitySignupCanceled:ie,onImageOpen:Ce,onIsolatedTextSelection:m=>h(n,m),signatureHtml:y?void 0:n.signatureHtml,signatureText:y?void 0:n.signature}),tt=t.jsxs("button",{"aria-label":`复制第 ${n.floor} 楼链接`,className:"thread-floor-index",onClick:We,title:"复制楼层链接",type:"button",children:["#",n.floor]}),rt=t.jsxs(t.Fragment,{children:[t.jsx(qr,{canDelete:(!d||l)&&(n.canDelete??n.isOwn??!1),canEdit:(!d||l)&&!!n.isOwn,canQuote:e,canReply:r,deleting:F,editHref:o,onDelete:m=>{re.current=m,H(""),A({kind:"floor"})},onQuote:m=>I(n,m),onReply:()=>je()}),E&&t.jsx("p",{className:"thread-floor-delete-error",role:"alert",children:E}),ae.length>0&&t.jsx("section",{className:"nested-replies","aria-label":`${n.floor} 楼的楼中楼回复`,children:ae.map(m=>t.jsxs("article",{children:[t.jsx("img",{src:m.author.avatar,alt:""}),t.jsxs("div",{className:"nested-reply-main",children:[t.jsxs("div",{className:"nested-reply-identity",children:[t.jsx("a",{className:"nested-reply-author",href:se(m.author.name),children:m.author.name}),m.target&&t.jsxs("span",{className:"nested-reply-target",children:[" ","回复"," ",t.jsx("a",{href:se(m.target),children:m.target})]})]}),m.contentHtml?t.jsx(He,{className:"nested-reply-content",html:m.contentHtml,onImageOpen:Ce,variant:"nested"}):t.jsx("p",{children:m.content}),t.jsxs("footer",{className:"nested-reply-footer",children:[t.jsx("time",{children:Ie(m.publishedAt)}),r&&t.jsx("button",{onClick:()=>je(m.author.name),type:"button",children:"回复"}),m.canDelete&&t.jsxs("button",{className:"nested-reply-delete",disabled:D===m.id,onClick:P=>{re.current=P.currentTarget,S(""),A({kind:"nested",reply:m})},type:"button",children:[t.jsx(ke,{size:12}),D===m.id?"删除中":"删除"]})]})]})]},m.id))}),Z&&t.jsx("p",{className:"nested-reply-delete-error",role:"alert",children:Z}),R!==void 0&&r&&t.jsxs("form",{className:"nested-reply-composer",onSubmit:Ve,children:[t.jsx("textarea",{"aria-label":R?`回复 @${R}`:`回复第 ${n.floor} 楼`,maxLength:500,onChange:m=>{B(m.target.value),Y("")},placeholder:R?`回复 @${R}`:"写一条楼中楼回复",ref:b,rows:2,value:_}),t.jsxs("div",{className:"nested-reply-composer-actions",children:[t.jsx("button",{"aria-label":"取消楼中楼回复",className:"nested-reply-cancel",disabled:j,onClick:Ee,type:"button",children:t.jsx(Ae,{size:15})}),t.jsxs("button",{className:"nested-reply-submit",disabled:!_.trim()||j,type:"submit",children:[t.jsx(kt,{size:14}),j?"发送中":"发送"]})]}),w&&t.jsx("p",{className:"nested-reply-error",role:"alert",children:w})]})]}),at=t.jsxs(t.Fragment,{children:[z&&t.jsxs("div",{"aria-live":"polite",className:"copy-floor-toast",role:"status",children:[t.jsx(St,{"aria-hidden":"true",size:15}),"已复制楼层链接"]}),p&&t.jsx(Xt,{images:p.images,initialImageIndex:p.imageIndex,onImageChange:p.onImageChange,onClose:Ye}),C&&t.jsx(Lr,{floor:n,isMainPost:l,onCancel:Xe,onConfirm:Qe,target:C})]});return t.jsx(Tr,{articleAfterContent:at,author:n.author,avatarRail:Ze,content:et,decorationImageSrc:a,editedAt:n.editedAt,floor:n.floor,floorIndex:tt,id:String(n.floor),inlineAvatar:c,mainAfterContent:rt,onCopy:Nr,publishedAt:n.publishedAt,showAuthorProfile:g})}function Pe(e){const r=e.closest(".thread-floor")?.querySelector(".thread-floor-body");return Ct(window.getSelection(),r??null)}function Lr({floor:e,isMainPost:r,onCancel:a,onConfirm:o,target:n}){const d=n.kind==="nested"?n.reply:null,l=d?"删除楼中楼回复":r?"删除主楼":"删除回复",c=d?"":r?"删除主楼后，下一楼将顺位成为主楼；如果没有其他回复，整个主题会被删除。":"删除后，该楼内容将移入回收站，后续楼层编号会顺次调整。",g=d?.author.name??e.author.name,y=d?`#${e.floor} · 楼中楼`:`#${e.floor}`,s=Mr(d?.content||e.quoteText||e.paragraphs[0]||"");return i.useEffect(()=>(document.body.classList.add("thread-delete-dialog-open"),()=>document.body.classList.remove("thread-delete-dialog-open")),[]),i.useEffect(()=>{function f(h){h.key==="Escape"&&a()}return document.addEventListener("keydown",f),()=>document.removeEventListener("keydown",f)},[a]),t.jsx("div",{className:"thread-delete-dialog-backdrop",onMouseDown:f=>{f.currentTarget===f.target&&a()},role:"presentation",children:t.jsxs("section",{"aria-describedby":c?"thread-delete-dialog-description":void 0,"aria-labelledby":"thread-delete-dialog-title","aria-modal":"true",className:"thread-delete-dialog",role:"dialog",children:[t.jsxs("header",{children:[t.jsx("span",{className:"thread-delete-dialog-icon","aria-hidden":"true",children:t.jsx($t,{size:19})}),t.jsx("div",{children:t.jsx("h2",{id:"thread-delete-dialog-title",children:l})}),t.jsx("button",{"aria-label":"关闭删除确认",onClick:a,type:"button",children:t.jsx(Ae,{size:18})})]}),t.jsxs("div",{className:"thread-delete-dialog-body",children:[c&&t.jsx("p",{id:"thread-delete-dialog-description",children:c}),t.jsxs("div",{className:"thread-delete-dialog-target",children:[t.jsxs("span",{children:[g," · ",y]}),t.jsx("p",{children:s||"此回复没有可预览的文字内容。"})]})]}),t.jsxs("footer",{children:[t.jsx("button",{autoFocus:!0,className:"thread-delete-dialog-cancel",onClick:a,type:"button",children:"取消"}),t.jsxs("button",{className:"thread-delete-dialog-confirm",onClick:o,type:"button",children:[t.jsx(ke,{size:15}),"确认删除"]})]})]})})}function Mr(e){const r=e.replace(/\s+/g," ").trim();return r.length>100?`${r.slice(0,100).trimEnd()}…`:r}function Pr(e){const r=a=>String(a).padStart(2,"0");return`${e.getFullYear()}-${r(e.getMonth()+1)}-${r(e.getDate())} ${r(e.getHours())}:${r(e.getMinutes())}:${r(e.getSeconds())}`}export{Ft as P,kr as T,Tr as a,qr as b,Br as c,Ht as w};
