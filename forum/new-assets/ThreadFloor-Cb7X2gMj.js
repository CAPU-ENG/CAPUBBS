...
<head>
  ...
  <base href="${Ar(Re())}">
  <meta http-equiv="Content-Security-Policy" content="${Ir()}">
  <style>${pr}</style>
  <style>
    html{--capubbs-frame-text-color:${y}}html.dark{--capubbs-frame-text-color:${i}}
    ...
    .capubbs-html-frame-root{display:flow-root;width:calc(100% - ${_e}px);${f}}.capubbs-html-frame-root iframe{display:inline-block;vertical-align:baseline}
  </style>
  <script>${xr(r,e,o)}<\/script>
</head>
<body><main class="capubbs-html-frame-root forum-markup forum-markup-${c}${A}">${n}</main></body>
</html>`}function xr(e,r,t){return`(function(){
  ...
  }());`}function vr(e){return e.replace(/<script\b([^>]*)>/gi,(r,t)=>`<script${t.replace(/\s+type\s*=\s*(?:"[^"]*"|'[^']*'|[^\s>]+)/gi,"")} type="text/capubbs-user-script">`)}function wr(e){if(!/<(?:img|iframe)\b/i.test(e))return e;const r=document.createElement("template");return r.innerHTML=e,r.content.querySelectorAll("iframe[src]").forEach(t=>{const o=ke(t.getAttribute("src")??"",Re());o&&(t.dataset.capubbsPlayerSrc=o,t.removeAttribute("src"))}),r.content.querySelectorAll("img[src]").forEach(t=>{const o=t.getAttribute("src")?.trim()??"";!o||/^(?:blob:|data:)/i.test(o)||(t.dataset.capubbsImageResourceSrc=o,t.setAttribute("fetchpriority","low"),t.removeAttribute("src"),t.removeAttribute("srcset"),t.closest("picture")?.querySelectorAll("source[srcset]").forEach(n=>{n.removeAttribute("srcset")}))}),r.innerHTML}function Pe(){return ue||(ue=fetch(Be,{credentials:"same-origin"}).then(e=>{if(!e.ok)throw new Error(`Failed to load jQuery: ${e.status}`);return e.text()}).catch(()=>null),ue)}function Ir(){return["default-src 'none'","script-src 'unsafe-inline' http: https: data: blob:","style-src 'unsafe-inline' http: https:","img-src http: https: data: blob:","media-src http: https: data: blob:","font-src http: https: data: blob:","frame-src http: https: data: blob:","child-src http: https: data: blob:","connect-src 'none'","object-src 'none'","form-action 'none'","upgrade-insecure-requests"].join("; ")}function Re(){return new URL("/bbs/content/",window.location.origin).href}function Ar(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Sr(e){return e.replace(/<\/style/gi,"<\\/style")}function kr(e){if(!e||typeof e!="object")return!1;const r=e;return r.source!==z||typeof r.frameId!="string"?!1:r.type==="embedded-player-layout"?Array.isArray(r.players)&&r.players.every(or):r.type==="document-request"?typeof r.token=="string":r.type==="anchor"?typeof r.offsetTop=="number"&&Number.isFinite(r.offsetTop)&&r.offsetTop>=0:r.type==="navigate"?typeof r.url=="string":r.type==="jquery-request"?!0:r.type==="image-resource-request"||r.type==="image-resource-layout"?typeof r.requestId=="string"&&r.requestId.length>0&&Array.isArray(r.bounds)&&r.bounds.every(t=>t&&["top","bottom","left","right"].every(o=>typeof t[o]=="number"&&Number.isFinite(t[o])))&&(r.type==="image-resource-layout"||"url"in r&&typeof r.url=="string"&&r.url.length>0):r.type==="selection"?typeof r.text=="string":r.type==="image-open"?typeof r.imageIndex=="number"&&Number.isSafeInteger(r.imageIndex)&&Array.isArray(r.images)&&r.images.length>0&&r.imageIndex>=0&&r.imageIndex<r.images.length&&r.images.every(t=>!!t&&typeof t=="object"&&typeof t.alt=="string"&&typeof t.elementIndex=="number"&&Number.isSafeInteger(t.elementIndex)&&t.elementIndex>=0&&typeof t.src=="string"&&t.src.length>0&&(t.galleryId===void 0&&t.galleryIndex===void 0||typeof t.galleryId=="number"&&Number.isSafeInteger(t.galleryId)&&t.galleryId>=0&&typeof t.galleryIndex=="number"&&Number.isSafeInteger(t.galleryIndex)&&t.galleryIndex>=0)):r.type==="resize"&&typeof r.height=="number"&&Number.isFinite(r.height)}function Rr(){const[e,r]=s.useState(()=>document.documentElement.classList.contains("dark"));return s.useEffect(()=>{const t=document.documentElement,o=()=>r(t.classList.contains("dark")),n=new MutationObserver(o);return n.observe(t,{attributeFilter:["class"],attributes:!0}),()=>n.disconnect()},[]),e}function Er({attachments:e=[],bodyClassName:r="thread-floor-body",bodyFallback:t=null,bodyHtml:o,floor:n,isActivitySignupCanceled:u=!1,onImageOpen:l,onIsolatedTextSelection:c,signatureClassName:d="thread-signature",signatureHtml:y,signatureText:i}){const p=l?(f,A,h,v)=>{const N=f[A];N&&l([N],0,h,v?()=>v(A):void 0)}:void 0;return a.jsxs(a.Fragment,{children:[o?a.jsx(qe,{className:r,floor:n,html:o,isActivitySignupCanceled:u,onImageOpen:l,onIsolatedTextSelection:c,variant:"floor"}):t,a.jsx(Cr,{attachments:e}),y?a.jsx(qe,{className:d,floor:n,html:y,onImageOpen:p,variant:"signature"}):i?a.jsx("footer",{className:d,children:a.jsx("p",{children:i})}):null]})}function Cr({attachments:e}){return e.length===0?null:a.jsxs("section",{"aria-label":"附件",className:"thread-attachments",children:[a.jsxs("header",{className:"thread-attachments-heading",children:[a.jsx(Ft,{"aria-hidden":"true",size:14}),a.jsx("span",{children:"附件"}),a.jsx("small",{children:e.length})]}),a.jsx("ul",{children:e.map(r=>{const t=a.jsxs(a.Fragment,{children:[a.jsx("span",{className:"thread-attachment-name",children:r.name}),a.jsx("small",{children:jr(r)}),r.exists!==!1&&a.jsx(At,{"aria-hidden":"true",size:15})]});return a.jsx("li",{children:r.exists===!1?a.jsx("div",{"aria-disabled":"true",className:"thread-attachment-link is-unavailable",children:t}):a.jsx("a",{className:"thread-attachment-link",download:r.name,href:r.downloadHref||`/bbs/download/?id=${encodeURIComponent(r.id)}`,children:t})},r.id)})})]})}function jr(e){if(e.exists===!1)return"文件不可用";const r=[Lr(e.size),(e.price??0)>0?"付费附件":"免费"];return e.downloadCount!==void 0&&r.push(`下载 ${e.downloadCount} 次`),r.join(" · ")}function Lr(e){if(e<=0)return"大小未知";if(e<1024)return`${e} B`;const r=["KB","MB","GB","TB"];let t=e,o=-1;do t/=1024,o+=1;while(t>=1024&&o<r.length-1);return`${t.toFixed(t>=10?1:2)} ${r[o]}`}function Tr({author:e,id:r}){const t=e.tags??[],[o,n]=s.useState(!1),u=s.useRef(null),l=s.useRef(null),c=s.useRef(null),d=s.useRef(null),y=t.map(i=>`${i.id}:${i.name}`).join("|");return s.useLayoutEffect(()=>{if(t.length===0){n(!1);return}const i=()=>{const f=u.current,A=l.current,h=c.current,v=d.current;if(!f||!A||!h||!v||f.offsetWidth===0)return;const N=h.getBoundingClientRect().width,L=v.getBoundingClientRect().width,S=Number.parseFloat(getComputedStyle(A).columnGap)||0,k=A.clientWidth-N-S,T=L>k+1;n(q=>q===T?q:T)};i();const p=new ResizeObserver(i);return[u.current,l.current,d.current].forEach(f=>{f&&p.observe(f)}),()=>p.disconnect()},[y,t.length]),a.jsxs("div",{id:r,ref:u,className:"author-hover-card",role:"dialog","aria-label":`${e.name} 的用户摘要`,children:[a.jsxs("div",{className:"author-card-head",children:[a.jsx("img",{src:e.avatar,alt:""}),a.jsxs("div",{className:"author-card-head-copy",children:[a.jsxs("div",{ref:l,className:"author-card-name-line","data-tags-overflow":o?"true":void 0,children:[a.jsx("strong",{ref:c,children:e.name}),a.jsx("div",{className:"author-card-tag-slot",children:a.jsx(pe,{size:"compact",tags:t})})]}),(e.stars>0||e.role)&&a.jsxs("span",{className:"author-card-status",children:["★".repeat(e.stars),e.stars>0&&e.role?" · ":"",e.role]})]})]}),o?a.jsx("div",{className:"author-card-tags-row",children:a.jsx(pe,{size:"compact",tags:t})}):null,e.medals?.length?a.jsx("div",{className:"author-card-medals",children:a.jsx(Fe,{medals:e.medals,profileName:e.name,variant:"compact"})}):null,a.jsx("div",{ref:d,className:"author-card-tag-width-measure","aria-hidden":"true",children:a.jsx(pe,{size:"compact",tags:t})}),a.jsxs("dl",{children:[a.jsxs("div",{children:[a.jsx("dt",{children:"主题"}),a.jsx("dd",{children:e.topics})]}),a.jsxs("div",{children:[a.jsx("dt",{children:"回复"}),a.jsx("dd",{children:e.replies})]}),a.jsxs("div",{children:[a.jsx("dt",{children:"签到"}),a.jsx("dd",{children:e.checkins})]})]}),a.jsxs("p",{children:["最近在线：",e.lastSeen]}),a.jsxs("a",{href:se(e.name),children:["查看个人主页 ",a.jsx(Mt,{size:13})]})]})}function Nr({author:e}){const r=e.tags??[],t=ze(r),o=se(e.name);return a.jsxs("aside",{className:"thread-author-profile","aria-label":`${e.name} 的资料`,children:[a.jsx("a",{"aria-label":`查看${e.name}的个人主页`,className:"thread-author-profile-avatar",href:o,children:a.jsx("img",{src:e.avatar,alt:""})}),a.jsx("div",{className:"thread-author-profile-identity",children:a.jsx("a",{href:o,children:e.name})}),(e.stars>0||e.role)&&a.jsxs("div",{className:"thread-author-profile-status",children:[e.stars>0&&a.jsx("span",{"aria-label":`${e.stars} 星`,children:"★".repeat(e.stars)}),e.role&&a.jsx("strong",{children:e.role})]}),a.jsx(De,{tags:t}),a.jsx(Fe,{medals:e.medals??[],profileName:e.name,variant:"compact"}),a.jsxs("dl",{className:"thread-author-profile-stats",children:[a.jsxs("div",{children:[a.jsx("dt",{children:"主题"}),a.jsx("dd",{children:e.topics})]}),a.jsxs("div",{children:[a.jsx("dt",{children:"回复"}),a.jsx("dd",{children:e.replies})]}),a.jsxs("div",{children:[a.jsx("dt",{children:"签到"}),a.jsx("dd",{children:e.checkins})]})]}),a.jsxs("p",{className:"thread-author-profile-last-seen",children:[a.jsx("span",{children:"最近在线"}),a.jsx("strong",{children:e.lastSeen})]})]})}function Ie(e){return e.replace(/^(\d{4})年(\d{2})月(\d{2})日\s+(\d{2})时(\d{2})分(\d{2})秒$/,"$1-$2-$3 $4:$5:$6")}function qr(e){const r=window.getSelection()?.toString();r&&(e.preventDefault(),e.clipboardData.setData("text/plain",r))}function Pr({articleAfterContent:e,author:r,avatarRail:t,className:o="",content:n,decorationImageSrc:u,editedAt:l,floor:c,floorIndex:d,id:y,inlineAvatar:i=!1,mainAfterContent:p,onCopy:f,publishedAt:A,showAuthorProfile:h}){const v=r.tags??[],N=ze(v);return a.jsxs("article",{className:`thread-floor${h?" thread-floor-with-author-profile":""}${o?` ${o}`:""}`,"data-floor":c,id:y,onCopy:f,children:[u&&a.jsx("span",{"aria-hidden":"true",className:"thread-floor-decoration",children:a.jsx("img",{alt:"",src:u})}),h?a.jsx(Nr,{author:r}):!i&&t,a.jsxs("div",{className:"thread-floor-main",children:[a.jsxs("header",{className:"thread-floor-header",children:[!h&&i&&t,a.jsxs("div",{className:"thread-floor-author",children:[a.jsx("a",{href:se(r.name),children:r.name}),a.jsx(De,{tags:N})]}),a.jsxs("div",{className:"thread-floor-time",children:[a.jsx("time",{children:Ie(A)}),l&&a.jsxs(a.Fragment,{children:[a.jsx("span",{children:"·"}),a.jsxs("time",{children:["编辑于 ",Ie(l)]})]})]}),d]}),h?a.jsx("div",{className:"thread-floor-content",children:n}):n,p]}),e]})}function Mr({canDelete:e,canEdit:r,canQuote:t,canReply:o,decorative:n=!1,deleting:u=!1,editHref:l="",onDelete:c,onQuote:d,onReply:y}){const i=n?-1:void 0,p=s.useRef(null);return a.jsxs("div",{"aria-hidden":n||void 0,className:`thread-floor-actions${n?" thread-floor-actions-decorative":""}`,children:[t&&a.jsxs("button",{onClick:f=>{const A=p.current?p.current.text:Me(f.currentTarget);p.current=null,d?.(A)},onPointerDown:f=>{f.button===0&&(p.current={text:Me(f.currentTarget)})},tabIndex:i,type:"button",children:[a.jsx(Rt,{size:15}),"引用"]}),o&&a.jsxs("button",{onClick:y,tabIndex:i,type:"button",children:[a.jsx(Ot,{size:15}),"回复"]}),r&&(n?a.jsxs("button",{tabIndex:-1,type:"button",children:[a.jsx(Te,{size:15}),"编辑"]}):a.jsxs("a",{href:l,children:[a.jsx(Te,{size:15}),"编辑"]})),e&&a.jsxs("button",{"aria-busy":u||void 0,className:"floor-action-danger",disabled:!n&&u,onClick:n?void 0:f=>c?.(f.currentTarget),tabIndex:i,type:"button",children:[a.jsx(Se,{size:15}),u?"删除中":"删除"]})]})}function Vr({canQuote:e,canReply:r,decorationImageSrc:t,editHref:o,floor:n,isActivityThread:u,isMainPost:l,inlineAvatar:c,showAuthorProfile:d,hideSignature:y,onDeleteFloor:i,onDeleteNestedReply:p,onIsolatedTextSelection:f,onQuote:A,onSubmitNestedReply:h,viewer:v}){const[N,L]=s.useState(!1),[S,k]=s.useState(null),[T,q]=s.useState([]),[j,H]=s.useState(""),[F,X]=s.useState(!1),[J,Q]=s.useState([]),[_,B]=s.useState(""),[Z,R]=s.useState(""),[D,ee]=s.useState(null),[I,Y]=s.useState(""),[C,O]=s.useState(!1),[E,m]=s.useState(void 0),[b,w]=s.useState(null),[P,W]=s.useState(!1),M=s.useRef(null),G=s.useRef(null),re=s.useRef(null),x=s.useRef(null),V=s.useRef(null),ae=s.useMemo(()=>[...n.nestedReplies??[],...J].filter(g=>!T.includes(g.id)),[T,n.nestedReplies,J]),ie=u&&!l&&/<\s*(?:s|strike)\b/i.test(n.contentHtml??""),ne=`thread-floor-body${ie?" capubbs-activity-signup-canceled":""}`;s.useEffect(()=>()=>{G.current!==null&&window.clearTimeout(G.current)},[]),s.useEffect(()=>{if(!P)return;function g($){M.current?.contains($.target)||W(!1)}return document.addEventListener("pointerdown",g),()=>document.removeEventListener("pointerdown",g)},[P]);async function We(){const g=`${window.location.origin}${window.location.pathname}${window.location.search}#${n.floor}`;await Ht(g)&&(L(!0),G.current!==null&&window.clearTimeout(G.current),G.current=window.setTimeout(()=>L(!1),1800))}const Ee=(g,$,K,me)=>{V.current=K,w({imageIndex:$,images:g,onImageChange:me})};function Ye(g){b?.onImageChange?.(g),w(null),window.requestAnimationFrame(()=>V.current?.focus())}function Ce(g=null){m(g),B(""),R(""),Y(""),window.requestAnimationFrame(()=>x.current?.focus())}function je(){m(void 0),B(""),Y("")}async function Ve(g){g.preventDefault();const $=_.trim();if(!(!$||!v||C)){O(!0),Y("");try{const K=await h(n,E??null,$);Q(me=>[...me,{author:v,canDelete:!0,content:$,id:K>0?String(K):`local-${n.id}-${Date.now()}`,publishedAt:Fr(new Date),target:E??void 0}]),je()}catch(K){Y(K instanceof Error?K.message:"楼中楼回复发布失败，请稍后重试。")}finally{O(!1)}}}async function Je(g){ee(g.id),R("");try{await p(n,g),q($=>[...$,g.id]),Q($=>$.filter(K=>K.id!==g.id)),k(null)}catch($){R($ instanceof Error?$.message:"楼中楼删除失败，请稍后重试。")}finally{ee(null)}}async function Ke(){if(!F){X(!0),H("");try{await i(n)}catch(g){H(g instanceof Error?g.message:"楼层删除失败，请稍后重试。"),X(!1)}}}function Xe(){k(null),H(""),R(""),window.requestAnimationFrame(()=>re.current?.focus())}function Qe(){if(!S)return;const g=S;k(null),g.kind==="floor"?Ke():Je(g.reply)}const Ze=a.jsxs("div",{className:`thread-avatar-rail${P?" thread-avatar-rail-open":""}`,ref:M,children:[a.jsx("button",{"aria-controls":`author-card-${n.floor}`,"aria-expanded":P,"aria-label":`查看${n.author.name}的资料卡`,className:"thread-avatar-button",onClick:()=>W(g=>!g),type:"button",children:a.jsx("img",{src:n.author.avatar,alt:""})}),a.jsx(Tr,{author:n.author,id:`author-card-${n.floor}`})]}),et=a.jsx(Er,{attachments:n.attachments,bodyFallback:a.jsx("div",{className:ne,children:n.paragraphs.map(g=>a.jsx("p",{children:g},g))}),bodyClassName:ne,bodyHtml:n.contentHtml,floor:n.floor,isActivitySignupCanceled:ie,onImageOpen:Ee,onIsolatedTextSelection:g=>f(n,g),signatureHtml:y?void 0:n.signatureHtml,signatureText:y?void 0:n.signature}),tt=a.jsxs("button",{"aria-label":`复制第 ${n.floor} 楼链接`,className:"thread-floor-index",onClick:We,title:"复制楼层链接",type:"button",children:["#",n.floor]}),rt=a.jsxs(a.Fragment,{children:[a.jsx(Mr,{canDelete:(!u||l)&&(n.canDelete??n.isOwn??!1),canEdit:(!u||l)&&!!n.isOwn,canQuote:e,canReply:r,deleting:F,editHref:o,onDelete:g=>{re.current=g,H(""),k({kind:"floor"})},onQuote:g=>A(n,g),onReply:()=>Ce()}),j&&a.jsx("p",{className:"thread-floor-delete-error",role:"alert",children:j}),ae.length>0&&a.jsx("section",{className:"nested-replies","aria-label":`${n.floor} 楼的楼中楼回复`,children:ae.map(g=>a.jsxs("article",{children:[a.jsx("img",{src:g.author.avatar,alt:""}),a.jsxs("div",{className:"nested-reply-main",children:[a.jsxs("div",{className:"nested-reply-identity",children:[a.jsx("a",{className:"nested-reply-author",href:se(g.author.name),children:g.author.name}),g.target&&a.jsxs("span",{className:"nested-reply-target",children:[" ","回复"," ",a.jsx("a",{href:se(g.target),children:g.target})]})]}),g.contentHtml?a.jsx(He,{className:"nested-reply-content",html:g.contentHtml,onImageOpen:Ee,variant:"nested"}):a.jsx("p",{children:g.content}),a.jsxs("footer",{className:"nested-reply-footer",children:[a.jsx("time",{children:Ie(g.publishedAt)}),r&&a.jsx("button",{onClick:()=>Ce(g.author.name),type:"button",children:"回复"}),g.canDelete&&a.jsxs("button",{className:"nested-reply-delete",disabled:D===g.id,onClick:$=>{re.current=$.currentTarget,R(""),k({kind:"nested",reply:g})},type:"button",children:[a.jsx(Se,{size:12}),D===g.id?"删除中":"删除"]})]})]})]},g.id))}),Z&&a.jsx("p",{className:"nested-reply-delete-error",role:"alert",children:Z}),E!==void 0&&r&&a.jsxs("form",{className:"nested-reply-composer",onSubmit:Ve,children:[a.jsx("textarea",{"aria-label":E?`回复 @${E}`:`回复第 ${n.floor} 楼`,maxLength:500,onChange:g=>{B(g.target.value),Y("")},placeholder:E?`回复 @${E}`:"写一条楼中楼回复",ref:x,rows:2,value:_}),a.jsxs("div",{className:"nested-reply-composer-actions",children:[a.jsx("button",{"aria-label":"取消楼中楼回复",className:"nested-reply-cancel",disabled:C,onClick:je,type:"button",children:a.jsx(Ae,{size:15})}),a.jsxs("button",{className:"nested-reply-submit",disabled:!_.trim()||C,type:"submit",children:[a.jsx(St,{size:14}),C?"发送中":"发送"]})]}),I&&a.jsx("p",{className:"nested-reply-error",role:"alert",children:I})]})]}),at=a.jsxs(a.Fragment,{children:[N&&a.jsxs("div",{"aria-live":"polite",className:"copy-floor-toast",role:"status",children:[a.jsx(kt,{"aria-hidden":"true",size:15}),"已复制楼层链接"]}),b&&a.jsx(Qt,{images:b.images,initialImageIndex:b.imageIndex,onImageChange:b.onImageChange,onClose:Ye}),S&&a.jsx($r,{floor:n,isMainPost:l,onCancel:Xe,onConfirm:Qe,target:S})]});return a.jsx(Pr,{articleAfterContent:at,author:n.author,avatarRail:Ze,content:et,decorationImageSrc:t,editedAt:n.editedAt,floor:n.floor,floorIndex:tt,id:String(n.floor),inlineAvatar:c,mainAfterContent:rt,onCopy:qr,publishedAt:n.publishedAt,showAuthorProfile:d})}function Me(e){const r=e.closest(".thread-floor")?.querySelector(".thread-floor-body");return Et(window.getSelection(),r??null)}function $r({floor:e,isMainPost:r,onCancel:t,onConfirm:o,target:n}){const u=n.kind==="nested"?n.reply:null,l=u?"删除楼中楼回复":r?"删除主楼":"删除回复",c=u?"":r?"删除主楼后，下一楼将顺位成为主楼；如果没有其他回复，整个主题会被删除。":"删除后，该楼内容将移入回收站，后续楼层编号会顺次调整。",d=u?.author.name??e.author.name,y=u?`#${e.floor} · 楼中楼`:`#${e.floor}`,i=zr(u?.content||e.quoteText||e.paragraphs[0]||"");return s.useEffect(()=>(document.body.classList.add("thread-delete-dialog-open"),()=>document.body.classList.remove("thread-delete-dialog-open")),[]),s.useEffect(()=>{function p(f){f.key==="Escape"&&t()}return document.addEventListener("keydown",p),()=>document.removeEventListener("keydown",p)},[t]),a.jsx("div",{className:"thread-delete-dialog-backdrop",onMouseDown:p=>{p.currentTarget===p.target&&t()},role:"presentation",children:a.jsxs("section",{"aria-describedby":c?"thread-delete-dialog-description":void 0,"aria-labelledby":"thread-delete-dialog-title","aria-modal":"true",className:"thread-delete-dialog",role:"dialog",children:[a.jsxs("header",{children:[a.jsx("span",{className:"thread-delete-dialog-icon","aria-hidden":"true",children:a.jsx($t,{size:19})}),a.jsx("div",{children:a.jsx("h2",{id:"thread-delete-dialog-title",children:l})}),a.jsx("button",{"aria-label":"关闭删除确认",onClick:t,type:"button",children:a.jsx(Ae,{size:18})})]}),a.jsxs("div",{className:"thread-delete-dialog-body",children:[c&&a.jsx("p",{id:"thread-delete-dialog-description",children:c}),a.jsxs("div",{className:"thread-delete-dialog-target",children:[a.jsxs("span",{children:[d," · ",y]}),a.jsx("p",{children:i||"此回复没有可预览的文字内容。"})]})]}),a.jsxs("footer",{children:[a.jsx("button",{autoFocus:!0,className:"thread-delete-dialog-cancel",onClick:t,type:"button",children:"取消"}),a.jsxs("button",{className:"thread-delete-dialog-confirm",onClick:o,type:"button",children:[a.jsx(Se,{size:15}),"确认删除"]})]})]})})}function zr(e){const r=e.replace(/\s+/g," ").trim();return r.length>100?`${r.slice(0,100).trimEnd()}…`:r}function Fr(e){const r=t=>String(t).padStart(2,"0");return`${e.getFullYear()}-${r(e.getMonth()+1)}-${r(e.getDate())} ${r(e.getHours())}:${r(e.getMinutes())}:${r(e.getSeconds())}`}export{Ft as P,Er as T,Pr as a,Mr as b,Vr as c,Ht as w};
