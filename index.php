<?php
    ...
    if (@$_SERVER['HTTP_HOST']=="bbs.chexie.net") {
        echo '<script>window.location="https://www.chexie.net/bbs/";</script></head></html>';
        exit;
    }
...
<footer class="footer">
    <p>
      <!-- <a href="http://www.qiche8.net/" target="_blank"> -->
        <!-- <img src="/bbs/images/a56e5ca6707358f21ba8f1bb1cc583858068c921.png" class="img-responsive img-rounded img-thumbnail" alt="洛克兄弟" title="洛克兄弟" width="320"> -->
        <img src="/bbs/images/a56e5ca6707358f21ba8f1bb1cc583858068c921.png" alt="洛克兄弟" title="洛克兄弟" width="320">
      <!-- </a> -->
