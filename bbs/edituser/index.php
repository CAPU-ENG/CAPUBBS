...
<tr><td class="left"><span>Email：</span></td><td class="right" style="width: 300px;">
    ...
    if (CAPUBBS_ENABLE_EMAIL_VERIFY):
        ...
        echo ' <a href="../home/?pos=verify_email" style="font-size:12px;">邮箱管理</a>';
    endif;
    ?>
    </td></tr>
...
<tr><td class="left"><span>签名档1：</span></td><td><textarea placeholder="每个签名档不超过50000字节；支持如[img]或[color]之类的转义" name="sig1" maxlength=50000><?php echo(trans($userinfo['sig1'])); ?></textarea>
</td></tr>
...
<td>
<input style="width: initial;" type="radio" name="sig1_type" value="raw" <?php echo((!isset($userinfo['sig1_type']) || $userinfo['sig1_type']=='raw') ? 'checked' : ''); ?>><span>Raw</span>
<input style="width: initial;" type="radio" name="sig1_type" value="html" <?php echo((isset($userinfo['sig1_type']) && $userinfo['sig1_type']=='html') ? 'checked' : ''); ?>> <span>HTML</span>
</td>
</tr>

<tr>
<td class="left"><span>签名档2：</span></td>
<td><textarea placeholder="每个签名档不超过50000字节；支持如[img]或[color]之类的转义" name="sig2" maxlength=50000><?php echo(trans($userinfo['sig2'])); ?></textarea></td>
</tr>

<tr>
<td class="left"><span>签名档2类型：</span></td>
<td>
<input style="width: initial;" type="radio" name="sig2_type" value="raw" <?php echo((!isset($userinfo['sig2_type']) || $userinfo['sig2_type']=='raw') ? 'checked' : ''); ?>><span>Raw</span>
<input style="width: initial;" type="radio" name="sig2_type" value="html" <?php echo((isset($userinfo['sig2_type']) && $userinfo['sig2_type']=='html') ? 'checked' : ''); ?>> <span>HTML</span>
</td>
</tr>

<tr><td class="left"><span>签名档3：</span></td><td><textarea placeholder="每个签名档不超过50000字节；支持如[img]或[color]之类的转义" name="sig3" maxlength=50000><?php echo(trans($userinfo['sig3'])); ?></textarea>
</td></tr>

<tr>
<td class="left"><span>签名档3类型：</span></td>
<td>
<input style="width: initial;" type="radio" name="sig3_type" value="raw" <?php echo((!isset($userinfo['sig3_type']) || $userinfo['sig3_type']=='raw') ? 'checked' : ''); ?>><span>Raw</span>
<input style="width: initial;" type="radio" name="sig3_type" value="html" <?php echo((isset($userinfo['sig3_type']) && $userinfo['sig3_type']=='html') ? 'checked' : ''); ?>> <span>HTML</span>
</td>
</tr>
