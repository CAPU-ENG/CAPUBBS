                    ...
                    if ($currentuser == "") {
                        ...
                        <div style='justify-content: center; align-items: center; border: 1px solid black; padding: 10px 10px 10px 10px;'>
                            <div style="text-align: center;">
                                ...
                                <br>
                                <br>
                                <button onclick="location.href='utils/getExcel.php?bid=<?php echo $bid; ?>&tid=<?php echo $tid; ?>'">
                                    下载
                                </button>
                                <br>
                                <br>
                        ...
                        <div style='justify-content: center; align-items: center; border: 1px solid black; padding: 10px 10px 10px 10px;'>
                            <div style="text-align: center;">
                                ...
                                <button onclick="var scr=$('#modify_join_activity');if(scr.css('height')=='0px'){scr.animate({height:scr[0].scrollHeight});$(this).html('收起报名信息')}else{scr.animate({height:'0px'});this.innerHTML='修改报名信息'}">
                                    修改报名信息
                                </button>
                            </div>
                            <form action="#" id="modify_join_activity" method="POST"
                                ...
                                <div>签名档：
                                    <input type="radio" name="sign"
                                           value="0" <?php if ($optionValue["sign"] == 0) echo "checked"; ?>>不使用
                                    <input type="radio" name="sign"
                                           value="1" <?php if ($optionValue["sign"] == 1) echo "checked"; ?>>1
                                    <input type="radio" name="sign"
                                           value="2" <?php if ($optionValue["sign"] == 2) echo "checked"; ?>>2
                                    <input type="radio" name="sign"
                                           value="3" <?php if ($optionValue["sign"] == 3) echo "checked"; ?>>3
                                </div>
                                <br>
                                <button>修改</button>
                                <br>
                    ...
                    <tr>
                        <td class="lzltd">
                            <div id="writeboard<?php echo($i); ?>">
                                ...
                                <button class="lzlpostbt"
                                        onclick="dolzlreply(<?php echo($i . "," . $floor['fid']); ?>,this);">发表
                                </button>
                            </div>
                        </td>
                    </tr>
...
<div id="msg_overlay">
    <div>
        ...
        <button onclick="msg_send();" id="msg_sendbt">发送</button>&nbsp;<button onclick="msg_cancel();"
                                                                                 id="msg_cancelbt">取消
        </button>
    </div>
</div>
